...
<body>
											...
											<div class="dz-shop-card style-2">
												...
												<div class="dz-content">
													<div class="dz-header">
														<div>
															<h4 class="title mb-0">
																<a href="shop-list.html">Pakistani Eastern Wear Suit</a>
															</h4>
															<ul class="dz-tags">
													...
													<div class="dz-body">
														<div class="dz-rating-box">
															<div>
																<p class="dz-para">
																	Premium quality Pakistani Eastern Wear suit. Soft
																	fabric, elegant embroidery,
																	and perfect for festive & casual occasions.
																</p>
															</div>
														</div>
											...
											<div class="dz-shop-card style-2">
												...
												<div class="dz-content">
													<div class="dz-header">
														<div>
															<h4 class="title mb-0">
																<a href="shop-list.html">Pakistani Eastern Short
																	Shirt</a>
															</h4>
															<ul class="dz-tags">
																<li><a href="shop-with-category.html">Ready-to-Wear,</a>
													...
													<div class="dz-body">
														<div class="dz-rating-box">
															<div>
																<p class="dz-para">
																	Elegant stitched short frock with soft lawn fabric
											...
											<div class="dz-shop-card style-2">
												...
												<div class="dz-content">
													<div class="dz-header">
														<div>
															<h4 class="title mb-0">
																<a href="shop-list.html">Embroidered Silk Shalwar Kameez
																	(Green Bottom)</a>
															</h4>
													...
													<div class="dz-body">
														<div class="dz-rating-box">
															<div>
																<p class="dz-para">
																	Premium embroidered silk shalwar kameez with a
																	stylish green bottom.
																	Perfect for festive and formal occasions with
																	elegant detailing.
																</p>
															</div>
														</div>
											...
											<div class="dz-shop-card style-2">
												...
												<div class="dz-content">
													<div class="dz-header">
														<div>
															<h4 class="title mb-0">
																<a href="shop-list.html">Western Wear – Casual Denim
																	Skinny Jeans</a>
															</h4>
													...
													<div class="dz-body">
														<div class="dz-rating-box">
															<div>
																<p class="dz-para">
																	Stylish and comfortable skinny jeans perfect for
																	daily wear.
																	Designed for a modern Western look with a soft
																	stretch denim
											...
											<div class="dz-shop-card style-2">
												...
												<div class="dz-content">
													<div class="dz-header">
														<div>
															<h4 class="title mb-0">
																<a href="shop-list.html">Cherry Farshi Set in Oversized
																	Fit</a>
															</h4>
															<ul class="dz-tags">
													...
													<div class="dz-body">
														<div class="dz-rating-box">
															<div>
																<p class="dz-para">
																	A premium Cherry Farshi set crafted with soft
																	fabric, elegant embroidery, and an oversized
																	modern silhouette. Perfect for festive wear and
																	casual gatherings.
																</p>
															</div>
														</div>
											...
											<div class="dz-shop-card style-2">
												...
												<div class="dz-content">
													<div class="dz-header">
														<div>
															<h4 class="title mb-0">
																<a href="shop-list.html">Loose Pajama Set – Soft &
																	Breathable Fabric</a>
															</h4>
															<ul class="dz-tags">
																<li><a href="shop-with-category.html">Women's Wear,</a>
													...
													<div class="dz-body">
														<div class="dz-rating-box">
															<div>
																<p class="dz-para">
																	Ultra-comfortable loose pajama set crafted from
																	soft, breathable cotton blend.
																	Perfect for sleepwear, everyday lounging, or casual
																	at-home wear.
																</p>
															</div>
														</div>
									...
									<div class="row gx-xl-4 g-3 mb-xl-0 mb-md-0 mb-3">
										<div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
											<div class="shop-card style-1">
												<div class="dz-media">
													...
													<div class="shop-meta">
														<a href="javascript:void(0);"
															...
															data-name="Pakistani Eastern Wear Suit"
															data-price="PKR 4,500"
															data-img="images/shop/product/img1.jpg"
															data-desc="Elegant Pakistani Eastern Wear Suit, ideal for formal events and gatherings."
															data-sku="EW-1001"
															data-category="Pakistani Eastern Wear, Ready-to-Wear"
															data-tags="Festive, Formal, Embroidery">
												...
												<div class="dz-content">
													<h5 class="title"><a href="shop-list.html">Pakistani Eastern Wear
															Suit</a></h5>
												...
												<div class="dz-media">
													...
													<div class="shop-meta">
														<a href="javascript:void(0);"
															class="btn btn-secondary btn-md btn-rounded quick-view-btn"
															data-bs-toggle="modal" data-bs-target="#quickViewModal"
															data-name="Pakistani Eastern Short Shirt"
															data-price="PKR 3,850"
															data-img="images/shop/product/img2.jpg"
															data-desc="Traditional Pakistani eastern short shirt, perfect for casual or semi-formal occasions."
															data-sku="EW-101"
															data-category="Pakistani Eastern Wear, Casual"
															data-tags="Festive, Casual, Embroidery">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
														</a>
												...
												<div class="dz-media">
													...
													<div class="shop-meta">
														<a href="javascript:void(0);"
															...
															data-img="images/shop/product/img3.jpg"
															data-desc="Elegant embroidered silk shalwar kameez with a green bottom, perfect for festive occasions."
															data-sku="EW-1003"
															data-category="Pakistani Eastern Wear, Silk, Ready-to-Wear"
															data-tags="Festive, Embroidery, Formal">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
														</a>
												...
												<div class="dz-media">
													...
													<div class="shop-meta">
														<a href="javascript:void(0);"
															...
															data-desc="Elegant Pakistani Eastern Wear Suit, perfect for festive and formal occasions."
															data-sku="EW-1001"
															data-category="Pakistani Eastern Wear, Ready-to-Wear"
															data-tags="Festive, Formal, Embroidery">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
												...
												<div class="dz-media">
													...
													<div class="shop-meta">
														<a href="javascript:void(0);"
															...
															data-name="Pakistani Eastern Wear Suit"
															data-price="PKR 4,500"
															data-img="images/shop/product/img5.jpg"
															data-desc="Cherry Farshi Set in Oversized Fit"
															data-sku="EW-1001"
															data-category="Pakistani Eastern Wear, Ready-to-Wear"
															data-tags="Festive, Formal, Embroidery">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
												...
												<div class="dz-media">
													...
													<div class="shop-meta">
														<a href="javascript:void(0);"
															...
															data-desc="Loose Pajama Set – Soft & Breathable Fabric."
															data-sku="EW-1001"
															data-category="Pakistani Eastern Wear, Ready-to-Wear"
															data-tags="Festive, Formal, Embroidery">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
												...
												<div class="dz-media">
													...
													<div class="shop-meta">
														<a href="javascript:void(0);"
															...
															data-name="Pakistani Eastern Wear Suit"
															data-price="PKR 4,500"
															data-img="images/shop/product/img7.jpg"
															data-desc="Modest Summer Abaya – Lightweight & Breathable."
															data-sku="EW-1002"
															data-category="Pakistani Eastern Wear, Ready-to-Wear"
															data-tags="Festive, Formal, Embroidery">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
												...
												<div class="dz-media">
													...
													<div class="shop-meta">
														<a href="javascript:void(0);"
															...
															data-desc="Baggy Shirt & Skirt Co-Ord Set – Soft & Breathable Fabric."
															data-sku="EW-1003"
															data-category="Pakistani Eastern Wear, Ready-to-Wear"
															data-tags="Festive, Formal, Embroidery">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
								...
								<div class="tab-pane fade active show" id="tab-list-grid" role="tabpanel"
									...
									<div class="row gx-xl-4 g-3">
												...
												<div class="dz-media">
													...
													<div class="shop-meta">
														...
														<a href="javascript:void(0);"
															...
															data-price="PKR 4,500"
															data-img="images/shop/product/img5.jpg"
															data-desc="Elegant Pakistani Eastern Wear Suit, ideal for formal events."
															data-sku="EW-1001"
															data-category="Pakistani Eastern Wear, Ready-to-Wear"
															data-tags="Festive, Formal, Embroidery">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
												...
												<div class="dz-media">
													...
													<div class="shop-meta">
														...
														<a href="javascript:void(0);"
															...
															data-price="PKR 4,500"
															data-img="images/shop/product/img8.jpg"
															data-desc="Baggy Shirt & Skirt Co-Ord Set – Casual & Comfortable"
															data-sku="EW-1002"
															data-category="Pakistani Eastern Wear, Ready-to-Wear"
															data-tags="Festive, Formal, Embroidery">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
												...
												<div class="dz-media">
													...
													<div class="shop-meta">
														<a href="javascript:void(0);"
															...
															data-img="images/shop/product/img10.jpg"
															data-desc="Stylish and comfortable suit for everyday wear."
															data-sku="EW-1003"
															data-category="Pakistani Eastern Wear, Ready-to-Wear"
															data-tags="Casual, Comfortable, Modern">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
														</a>
														<div class="btn btn-primary meta-icon dz-wishicon">
										...
										<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
											<div class="shop-card style-1">
												<div class="dz-media">
													<img src="images/shop/product/img11.jpg" alt="image">
													<div class="shop-meta">
														<!-- Quick View Button -->
														<a href="javascript:void(0);"
															class="btn btn-secondary btn-md btn-rounded quick-view-btn"
															...
															data-img="images/shop/product/img11.jpg"
															data-desc="Stunning wedding wear perfect for ceremonies and receptions.">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
														</a>
														<div class="btn btn-primary meta-icon dz-wishicon">
												...
												<div class="dz-content">
													<h5 class="title"><a href="shop-list.html">Wedding Wear – Elegant
															Collection</a></h5>
	...
	<script>
		...
		// Optional extra info
		const skuElem = modal.querySelector('.extra-info p:nth-child(1)');
		const categoryElem = modal.querySelector('.extra-info p:nth-child(2)');
		const tagsElem = modal.querySelector('.extra-info p:nth-child(3)');
		...
		document.querySelectorAll('.quick-view-btn').forEach(button => {
			button.addEventListener('click', () => {
				...
				modalImg.src = img;
				modalImg.alt = name;
				modalPrice.innerHTML = `<strong>Price:</strong> ${price}`;
				modalDesc.textContent = desc;

				// Update extra info
				skuElem.innerHTML = `<strong>SKU:</strong> ${sku}`;
				categoryElem.innerHTML = `<strong>Category:</strong> ${category}`;
				tagsElem.innerHTML = `<strong>Tags:</strong> ${tags}`;
			});
		});
