...
<li class="has-mega-menu sub-menu-down" style="position:relative;">
    ...
    <div class="dz-content">
        <div class="dz-header">
            <div>
                ...
                <ul class="dz-tags">
                    <li><a href="shop-with-category.html">Unstitched,</a></li>
                    <li><a href="shop-with-category.html">Ready-to-Wear</a></li>
                </ul>
            </div>
        ...
        <div class="dz-body">
            <div class="dz-rating-box">
                <div>
                    <p class="dz-para">
                        Premium quality Pakistani Eastern Wear suit. Soft fabric, elegant embroidery, 
    ...
    <div class="dz-header">
        <div>
            <h4 class="title mb-0">
                <a href="shop-list.html">Pakistani Eastern Short Shirt</a>
            </h4>
            <ul class="dz-tags">
                <li><a href="shop-with-category.html">Ready-to-Wear,</a></li>
                <li><a href="shop-with-category.html">Casual Wear</a></li>
            </ul>
        </div>
    ...
    <div class="dz-body">
        <div class="dz-rating-box">
            <div>
                <p class="dz-para">
                    Elegant stitched short frock with soft lawn fabric and delicate embroidery. 
                    Perfect for casual and semi-formal wear throughout the season.
                </p>
            </div>
        </div>
    ...
    <div class="dz-content">
        <div class="dz-header">
            <div>
                <h4 class="title mb-0">
                    <a href="shop-list.html">Embroidered Silk Shalwar Kameez (Green Bottom)</a>
                </h4>

                <ul class="dz-tags">
                    <li><a href="shop-with-category.html">Silk Collection,</a></li>
                    <li><a href="shop-with-category.html">Formal Wear</a></li>
                </ul>
            </div>
        ...
        <div class="dz-body">
            <div class="dz-rating-box">
                <div>
                    <p class="dz-para">
                        Premium embroidered silk shalwar kameez with a stylish green bottom. 
                        Perfect for festive and formal occasions with elegant detailing.
                    </p>
                </div>
            </div>
    ...
    <div class="dz-header">
        <div>
            <h4 class="title mb-0">
                <a href="shop-list.html">Western Wear – Casual Denim Skinny Jeans</a>
            </h4>

            <ul class="dz-tags">
                <li><a href="shop-with-category.html">Western Wear,</a></li>
                <li><a href="shop-with-category.html">Casual Jeans</a></li>
            </ul>
        </div>
    ...
    <div class="dz-body">
        <div class="dz-rating-box">
            <div>
                <p class="dz-para">
                    Stylish and comfortable skinny jeans perfect for daily wear. 
                    Designed for a modern Western look with a soft stretch denim 
    ...
    <div class="dz-header">
        <div>
            <h4 class="title mb-0">
                <a href="shop-list.html">Cherry Farshi Set in Oversized Fit</a>
            </h4>
            <ul class="dz-tags">
                <li><a href="shop-with-category.html">Women's Wear,</a></li>
                <li><a href="shop-with-category.html">Traditional Outfits</a></li>
            </ul>
        </div>
        <div class="review-num">
            <ul class="dz-rating">
    ...
    <div class="dz-body">
        <div class="dz-rating-box">
            <div>
                <p class="dz-para">
                    A premium Cherry Farshi set crafted with soft fabric, elegant embroidery, and an oversized
                    modern silhouette. Perfect for festive wear and casual gatherings.
                </p>
            </div>
        </div>
    ...
    <div class="dz-shop-card style-2">
        ...
        <div class="dz-content">
            <div class="dz-header">
                <div>
                    <h4 class="title mb-0">
                        <a href="shop-list.html">Loose Pajama Set – Soft & Breathable Fabric</a>
                    </h4>
                    <ul class="dz-tags">
                        <li><a href="shop-with-category.html">Women's Wear,</a></li>
                        <li><a href="shop-with-category.html">Loungewear</a></li>
                    </ul>
                </div>
                <div class="review-num">
                    <ul class="dz-rating">
            ...
            <div class="dz-body">
                <div class="dz-rating-box">
                    <div>
                        <p class="dz-para">
                            Ultra-comfortable loose pajama set crafted from soft, breathable cotton blend.
                            Perfect for sleepwear, everyday lounging, or casual at-home wear.
                        </p>
                    </div>
                </div>
    ...
    <div class="dz-shop-card style-2">
        ...
        <div class="dz-content">
            <div class="dz-header">
                <div>
                    <h4 class="title mb-0">
                        <a href="shop-list.html">Modest Summer Abaya – Lightweight & Breathable</a>
                    </h4>

                    <ul class="dz-tags">
                        <li><a href="shop-with-category.html">Modest Wear,</a></li>
            ...
            <div class="dz-body">
                <div class="dz-rating-box">
                    <div>
                        <p class="dz-para">
                            A breezy, lightweight abaya perfect for summer. Designed with soft, breathable fabric 
                            to keep you cool while maintaining elegant modest coverage.
                        </p>
                    </div>
                </div>
    ...
    <div class="dz-shop-card style-2">
        ...
        <div class="dz-content">
            <div class="dz-header">
                <div>
                    <h4 class="title mb-0">
                        <a href="shop-list.html">Baggy Shirt & Skirt Co-Ord Set</a>
                    </h4>

                    <ul class="dz-tags">
                        <li><a href="shop-with-category.html">Women's Wear,</a></li>
                        <li><a href="shop-with-category.html">Co-Ord Sets</a></li>
                    </ul>
                </div>
            ...
            <div class="dz-body">
                <div class="dz-rating-box">
                    <div>
                        <p class="dz-para">
                            A trendy oversized shirt paired with a flowy skirt. Perfect for everyday wear, offering
    ...
    <div class="shop-card style-1">
        <div class="dz-media">
            ...
            <div class="shop-meta">
                <!-- Quick View Button -->
                <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded quick-view-btn"
    ...
    <div class="shop-card style-1">
        <div class="dz-media">
            ...
            <div class="shop-meta">
                ...
                <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                   data-bs-toggle="modal" data-bs-target="#quickViewModal"
                   data-name="Cherry Farshi Set in Oversized Fit"
                   data-price="PKR 4,500"
                   data-img="images/shop/product/img5.jpg"
                   data-desc="Stylish Cherry Farshi set in an oversized fit, perfect for comfort and casual outings.">
                    <i class="fa-solid fa-eye d-md-none d-block"></i>
                    <span class="d-md-block d-none">Quick View</span>
                </a>
                <div class="btn btn-primary meta-icon dz-wishicon">
    ...
    <div class="shop-card style-1">
        <div class="dz-media">
            ...
            <div class="shop-meta">
                ...
                <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                   data-bs-toggle="modal" data-bs-target="#quickViewModal"
                   data-name="Modest Summer Abaya – Lightweight & Breathable"
                   data-price="PKR 5,500"
                   data-img="images/shop/product/img7.jpg"
                   data-desc="Lightweight and breathable summer abaya, perfect for modest and comfortable wear.">
                    <i class="fa-solid fa-eye d-md-none d-block"></i>
                    <span class="d-md-block d-none">Quick View</span>
                </a>
                <div class="btn btn-primary meta-icon dz-wishicon">
    ...
    <div class="shop-card style-1">
        ...
        <div class="dz-content">
            <h5 class="title"><a href="shop-list.html">Wedding Wear – Elegant Collection</a></h5>
    ...
    <div class="shop-card style-1">
        ...
        <div class="dz-content">
            <h5 class="title"><a href="shop-list.html">Wedding Wear – Designer Collection</a></h5>
