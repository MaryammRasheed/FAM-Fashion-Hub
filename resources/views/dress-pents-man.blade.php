...
<body>
                        ...
                        <div class="header-nav w3menu navbar-collapse collapse justify-content-start"
                                            ...
                                            <div class="mega-menu" style="width: 100%;">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-6 p-2"><a
                                                        ...
                                                        <ul>
                                                            <li><a href="shop-standard-clothes.html">Eastern Clothes</a>
                                                            </li>
                                                            <li><a href="shop-standard-clothes.html">Fusion</a></li>
                                                            <li><a href="shop-standard-clothes.html">Western Clothes</a>
                                                            </li>
                                                            <li><a href="shop-standard-clothes.html">Ready to Wear</a>
                                                            </li>
                                                            <li><a href="shop-standard-clothes.html">Unstitched</a></li>
                                                            <li><a href="shop-standard-clothes.html">Sleepovers</a></li>
                                                            <li><a href="shop-standard-clothes.html">Modest Wear</a>
                                                            </li>
                                                    ...
                                                    <div class="row g-0">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-6 p-2">
                                                            ...
                                                            <ul class="list-unstyled">
                                                                <li><a href="shoes-men-loafer.html">Loafer</a></li>
                                                                <li><a href="shoes-men-sneaker.html">Sneakers</a></li>
                                                                <li><a href="shoes-men-brouge.html">Brouges</a></li>
                                                                <li><a href="shoes-men-boots.html">Boots</a></li>
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-6 p-2">
                                                            ...
                                                            <ul class="list-unstyled ">
                                                                <li><a href="shoes-women-loafer.html">Loafer</a></li>
                                                                <li><a href="shoes-women-heels.html">Heels</a></li>
                                                                <li><a href="shoes-women-flats.html">Flat</a></li>
                                                                <li><a href="shoes-women-boots.html">Boots</a></li>
                                                            </ul>
                                                        </div>
                                                ...
                                                <li class="p-0 m-0">
                                                    <div class="row g-0">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-6 p-4">
                                                            ...
                                                            <ul class="list-unstyled ">
                                                                <li><a href="cosmetics-skincare.html">SkinCare</a></li>
                                                                <li><a href="cosmetics-makeup.html">Makeup</a></li>
                                                                <li><a href="cosmetics-haircare.html">HairCare</a></li>
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="has-mega-menu sub-menu-down" style="position:relative;">
                                    ...
                                    <div class="mega-menu shop-menu p-2 m-2"
                                        style="width:max-content; white-space:nowrap; display:flex; flex-direction:column;">
        ...
        <div class="offcanvas-body">
            <div class="product-description">
                ...
                <div class="widget widget_categories">
                    ...
                    <ul>
                        <li class="cat-item cat-item-26"><a href="blog-category.html">Necklaces</a> (12)</li>
                        <li class="cat-item cat-item-36"><a href="blog-category.html">Earrings</a> (18)</li>
                        <li class="cat-item cat-item-43"><a href="blog-category.html">Bracelets</a> (15)</li>
                        <li class="cat-item cat-item-27"><a href="blog-category.html">Rings</a> (20)</li>
                        <li class="cat-item cat-item-40"><a href="blog-category.html">Watches</a> (8)</li>
                        <li class="cat-item cat-item-40"><a href="blog-category.html">Bangles</a> (14)</li>
                        <li class="cat-item cat-item-40"><a href="blog-category.html">Anklets</a> (10)</li>
                        <li class="cat-item cat-item-43"><a href="blog-category.html">Cufflinks</a> (6)</li>
                        <li class="cat-item cat-item-36"><a href="blog-category.html">Brooches</a> (9)</li>
                    </ul>
                </div>
    ...
    <div class="page-content bg-light">
        ...
        <div class="dz-bnr-inr bg-secondary overlay-black-light"
            style="background-image:url(images/background/banner-man.jpg);">
            <div class="container">
                <div class="dz-bnr-inr-entry">
                    ...
                    <nav aria-label="breadcrumb" class="breadcrumb-row">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Men Clothes</li>
                        </ul>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="shop-filter mt-xl-2 mt-0">
                                <aside>
                                    ...
                                    <div class="widget widget_categories">
                                        <h6 class="widget-title">Category</h6>
                                        <ul>
                                            <li class="cat-item cat-item-26"><a href="blog-category.html">Dresses</a>
                                                (10)</li>
                                            ...
                                            <li class="cat-item cat-item-27"><a href="blog-category.html">Jewelry</a>
                                                (13)</li>
                                            <li class="cat-item cat-item-40"><a href="blog-category.html">Makeup</a>
                                                (06)</li>
                                            ...
                                            <li class="cat-item cat-item-40"><a href="blog-category.html">Shaving &amp;
                                                    Grooming</a> (13)</li>
                                            <li class="cat-item cat-item-43"><a href="blog-category.html">Jacket</a>
                                                (06)</li>
                                            <li class="cat-item cat-item-36"><a href="blog-category.html">Coat</a> (22)
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/grey-pentss.jpg" alt="Men's T-Shirt">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's Grey Dress Pants</a>
                                                            </h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Casual,</a></li>
                                                                <li><a href="shop-with-category.html">Men</a></li>
                                                            </ul>
                                                        </div>
                                                        <div class="review-num">
                                                            <ul class="dz-rating">
                                                                <li class="star-fill"><i class="flaticon-star-1"></i>
                                                                </li>
                                                                <li class="star-fill"><i class="flaticon-star-1"></i>
                                                                </li>
                                                                <li class="star-fill"><i class="flaticon-star-1"></i>
                                                            ...
                                                            <span><a href="javascript:void(0);"> 180 Reviews</a></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Comfortable and stylish Men’s Grey Dress Pants. Made
                                                                    from soft cotton for daily wear and casual outings.
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="rate">
                                                            <div class="d-flex align-items-center mb-xl-3 mb-2">
                                                                <div class="meta-content m-0">
                                                                    ...
                                                                    <span class="price">PKR 1,250</span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="bookmark-btn style-1">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        id="favoriteCheckMenTshirt">
                                                                    <label class="form-check-label"
                                                                        for="favoriteCheckMenTshirt">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/Men Solid Color Straight Casual.jpg" alt="Men's Jeans">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's Premium Cotton
                                                                    Dress Pants</a>
                                                            </h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Casual,</a></li>
                                                        ...
                                                        <div class="review-num">
                                                            ...
                                                            <span><a href="javascript:void(0);"> 420 Reviews</a></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Soft and breathable cotton pents for men, perfect
                                                                    for casual wear or outdoor activities. Stylish
                                                                    design with a comfortable fit.
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="rate">
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="bookmark-btn style-1">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        id="favoriteCheckMenTshirt2">
                                                                    <label class="form-check-label"
                                                                        for="favoriteCheckMenTshirt2">
                                                                        <i class="fa-solid fa-heart"></i>
                                                                    </label>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/Men's Dress Pants Trousers Chinos.jpg" alt="Men's Casual Jeans">
                                                </div>
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's Classic Casual Dress Pants</a>
                                                            </h4>

                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Csaual, lomg dress pants
                                                                        Collection,</a></li>
                                                                <li><a href="shop-with-category.html">Casual Wear</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        ...
                                                        <div class="review-num">
                                                            ...
                                                            <span><a href="javascript:void(0);"> 520 Reviews</a></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Stylish and comfortable men's dress pants made from
                                                                    soft cotton blend. Perfect for casual outings and
                                                        ...
                                                        <div class="rate">
                                                            <div class="d-flex align-items-center mb-xl-3 mb-2">
                                                                <div class="meta-content">
                                                                    <span class="price-name">Price</span>
                                                                    <span class="price">PKR 2,250</span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="bookmark-btn style-1">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        id="favoriteCheckPolo">
                                                                    <label class="form-check-label"
                                                                        for="favoriteCheckPolo">
                                                                        <i class="fa-solid fa-heart"></i>
                                                                    </label>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/Men's Solid Color Pleated Slim Straight Suit Pants.jpg" alt="Men's cozy Jeans">
                                                </div>
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's Solid Color Pleated Slim Straight Suit Pants</a>
                                                            </h4>

                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Casual
                                                                        Collection,</a></li>
                                                                <li><a href="shop-with-category.html">Casual Wear</a>
                                                                </li>
                                                            </ul>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Stylish and comfortable men's casual dress pants made from
                                                                    soft cotton blend. Perfect for casual outings and
                                                                    semi-formal occasions.
                                                                </p>
                                                            </div>
                                                        ...
                                                        <div class="rate">
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="bookmark-btn style-1">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        id="favoriteCheckPolo2">
                                                                    <label class="form-check-label"
                                                                        for="favoriteCheckPolo2">
                                                                        <i class="fa-solid fa-heart"></i>
                                                                    </label>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/Men's Dress Pants Trousers Chinos.jpg" alt="Men's Formal Dress Pants">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's Formal Dress Pants</a>
                                                            </h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Men's Wear,</a>
                                                                </li>
                                                                <li><a href="shop-with-category.html">Formal Dress Pants</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="review-num">
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Premium men's casual dress pants made from soft cotton.
                                                                    Elegant design with a tailored fit, ideal for
                                                                    office, formal events, and festive occasions.
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="rate">
                                                            <div class="d-flex align-items-center mb-xl-3 mb-2">
                                                                <div class="meta-content">
                                                                    <span class="price-name">Price</span>
                                                                    <span class="price">PKR 3,200</span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="bookmark-btn style-1">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        id="favoriteCheckDressShirt">
                                                                    <label class="form-check-label"
                                                                        for="favoriteCheckDressShirt">
                                                                        <i class="fa-solid fa-heart"></i>
                                                                    </label>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/grey-pentss.jpg" alt="Men's Casual Dress Pants">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's Grey Pents – Soft &
                                                                    Breathable Fabric</a>
                                                            </h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Men's Wear,</a>
                                                                </li>
                                                                <li><a href="shop-with-category.html">Formal Shirts</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="review-num">
                                                            ...
                                                            <span><a href="javascript:void(0);">256 Reviews</a></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Ultra-comfortable men's dress pants crafted from
                                                                    soft, breathable cotton blend.
                                                                    Perfect for office, semi-formal, and everyday wear.
                                                                </p>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/Khaki Straight L Pants.jpg" alt="Men's Dress Pants">
                                                </div>
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's Khaki Straight Long Pants</a>
                                                                </a>
                                                            </h4>
                                                            ...
                                                            <ul class="dz-tags">
                                                                ...
                                                                <li><a href="shop-with-category.html">Casual Dress Pants</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        ...
                                                        <div class="review-num">
                                                            ...
                                                            <span><a href="javascript:void(0);">776 Reviews</a></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Comfortable men's casual dress pants designed for
                                                                    daily wear. Soft stretch fabric
                                                                    ensures flexibility and a modern fit suitable for
                                                                    any casual outing.
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="rate">
                                                            <div class="d-flex align-items-center mb-xl-3 mb-2">
                                                                <div class="meta-content">
                                                                    <span class="price-name">Price</span>
                                                                    <span class="price">PKR 5,800</span>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/Men Solid Color Straight Casual.jpg" alt="Men's Solid Color Straight Casual">
                                                </div>
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's Solid Color Straight Casual</a>
                                                            </h4>

                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Men's Wear,</a>
                                                                </li>
                                                                <li><a href="shop-with-category.html">Traditional
                                                                        Wear</a></li>
                                                            </ul>
                                                        </div>
                                                        ...
                                                        <div class="review-num">
                                                            ...
                                                            <span><a href="javascript:void(0);">255 Reviews</a></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    A classic men’s kurta crafted from soft, breathable
                                                                    fabric.
                                                                    Ideal for traditional occasions, casual outings, and
                                                                    festive wear.
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="rate">
                                                            <div class="d-flex align-items-center mb-xl-3 mb-2">
                                                                <div class="meta-content">
                                                                    <span class="price-name">Price</span>
                                                                    <span class="price">PKR 3,600</span>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="row gx-xl-4 g-3 mb-xl-0 mb-md-0 mb-3">
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media" div
                                                    ...
                                                    <img src="images/clothes/Khaki Straight L Pants.jpg" alt="image" style="position: absolute; top: 0; left: 0; width: 100%;
																		 height: 100%; object-fit: cover; object-position: top;">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Mans Khaki Straight Leg Pants"
                                                            data-price="PKR 6,800"
                                                            data-img="images/clothes/Khaki Straight Leg Pants.jpg"
                                                            data-desc="Beautiful men’s khaki straight leg pants with elegant look and comfortable fit. Perfect for casual and trendy looks.">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's khaki straight leg pants</a>
                                                    </h5>
                                                    <h5 class="price">PKR 6,800</h5>
                                                </div>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media" div
                                                    style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
                                                    <img src="images/clothes/Men's Solid Color Pleated Slim Straight Suit Pants.jpg" alt="image" style="position: absolute; top: 0; left: 0; width: 100%;
																		 height: 100%; object-fit: cover; object-position: top;">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Solid Color Pleated Slim Straight Suit Pants"
                                                            data-price="PKR 6,800"
                                                            data-img="images/clothes/Men's Solid Color Pleated Slim Straight Suit Pants.jpg"
                                                            data-desc="Beautiful men’s solid color pleated slim straight suit pants with comfortable fit and stylish design. Perfect for formal and professional settings.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                        <div class="btn btn-primary meta-icon dz-wishicon">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Solid Color Pleated Slim Straight Suit Pants</a></h5>
                                                    <h5 class="price">PKR 6,800</h5>
                                                </div>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media" div
                                                    style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
                                                    <img src="images/clothes/Men's Dress Pants Trousers Chinos.jpg" alt="image" style="position: absolute; top: 0; left: 0; width: 100%;
																		 height: 100%; object-fit: cover; object-position: top;">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Mans Dress Pants Trousers Chinos"
                                                            data-price="PKR 4,200"
                                                            data-img="images/clothes/Men's Dress Pants Trousers Chinos.jpg"
                                                            data-desc="Beautiful men’s dress pants with elegant look and comfortable fit. Perfect for formal and semi-formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                        <div class="btn btn-primary meta-icon dz-wishicon">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's khaki straight leg pants</a></h5>
                                                    <h5 class="price">PKR 6,800</h5>
                                                </div>
                                                ...
                                                <div class="dz-media" div
                                                    ...
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            data-price="PKR 6,800"
                                                            data-img="images/clothes/Men's Solid Color Pleated Slim Straight Suit Pants.jpg"
                                                            data-desc="Solid color pleated slim straight suit pants for men with a comfortable and stylish look. Perfect for formal and semi-formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                        <div class="btn btn-primary meta-icon dz-wishicon">
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media" div
                                                    style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
                                                    <img src="images/clothes/Men Solid Color Straight Casual.jpg" alt="image" style="position: absolute; top: 0; left: 0; width: 100%;
																		 height: 100%; object-fit: cover; object-position: top;">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Solid Color Straight Casual Pants"
                                                            data-price="PKR 4,500"
                                                            data-img="images/clothes/Men Solid Color Straight Casual.jpg"
                                                            data-desc="Solid color straight casual pants for men with a comfortable and stylish look. Perfect for everyday wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                        <div class="btn btn-primary meta-icon dz-wishicon">
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media"
                                                    style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
                                                    <img src="images/clothes/Men's Solid Color Pleated Slim Straight Suit Pants.jpg" alt="image" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;
                                                    ...
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            data-price="PKR 6,800"
                                                            data-img="images/clothes/Men's Solid Color Pleated Slim Straight Suit Pants.jpg"
                                                            data-desc="Solid color pleated slim straight suit pants for men with a comfortable and stylish look. Perfect for formal and professional settings.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media"
                                                  style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
                                                    <img src="images/clothes/Men's Dress Pants Trousers Chinos.jpg" alt="image" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;
                                                                   object-fit: cover; object-position: top;">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Dress Pants Trousers Chinos"
                                                            data-price="PKR 5,500"
                                                            data-img="images/clothes/Men's Dress Pants Trousers Chinos.jpg"
                                                            data-desc="Dress pants trousers chinos for men with a comfortable and stylish look. Perfect for formal and professional settings.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                        <div class="btn btn-primary meta-icon dz-wishicon">
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img-men9.jpg" alt="image">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Baggy Jeans</a></h5>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img-men10.jpg" alt="image">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded"
                                                            data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Dress Pants</a></h5>
                                ...
                                <div class="tab-pane fade active show" id="tab-list-grid" role="tabpanel"
                                    ...
                                    <div class="row gx-xl-4 g-3">
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/Men's Dress Pants Trousers Chinos.jpg"
                                                        alt="Men's Dress Pants">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Dress Pants" data-price="PKR 4,500"
                                                            data-img="images/clothes/Men's Dress Pants Trousers Chinos.jpg"
                                                            data-desc="Stylish and comfortable men's dress pants, perfect for formal wear and professional settings. Made from high-quality fabric.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Dress Pants</a>
                                                    </h5>
                                                    <h5 class="price">PKR 4,500</h5>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/Khaki Straight L Pants.jpg"
                                                        alt="Men's Premium Cotton Leg pants">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Premium Cotton Leg Pants"
                                                            data-price="PKR 3,850"
                                                            data-img="images/clothes/Khaki Straight L Pants.jpg"
                                                            data-desc="Traditional Pakistani Eastern short shirt styled as a premium cotton t-shirt. Comfortable and perfect for casual or semi-formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Premium Cotton
                                                           Leg Pants</a></h5>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/grey-pentss.jpg"
                                                        alt="Men's Slim grey pants Jeans">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Slim Fit Grey Pants" data-price="PKR 6,950"
                                                            data-img="images/clothes/grey-pentss.jpg"
                                                            data-desc="Premium men's slim fit grey pants crafted with soft, breathable fabric. Perfect for casual or semi-formal wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Slim Fit Grey Pants</a></h5>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/Men's Solid Color Pleated Slim Straight Suit Pants.jpg"
                                                        alt="Western Wear – Casual Long Jeans">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Solid Color Pleated Slim Straight Suit Pants"
                                                            data-price="PKR 5,950"
                                                            data-img="images/clothes/Men's Solid Color Pleated Slim Straight Suit Pants.jpg"
                                                            data-desc="Premium men's solid color pleated slim straight suit pants for formal or casual wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Solid Color Pleated Slim Straight Suit Pants</a>
                                                    </h5>
                                                    <h5 class="price">PKR 5,950</h5>
                                                </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/Men's Solid Color Pleated Slim Straight Suit Pants.jpg"
                                                        alt="Men's Solid Color Pleated Slim Straight Suit Pants">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Solid Color Pleated Slim Straight Suit Pants" data-price="PKR 5,950"
                                                            data-img="images/clothes/Men's Solid Color Pleated Slim Straight Suit Pants.jpg"
                                                            data-desc="Premium men's solid color pleated slim straight suit pants for formal or casual wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/Men's Dress Pants Trousers Chinos.jpg"
                                                        alt="Men's Dress Pants Trousers Chinos">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Dress Pants Trousers Chinos"
                                                            data-price="PKR 4,250"
                                                            data-img="images/clothes/Men's Dress Pants Trousers Chinos.jpg"
                                                            data-desc="Comfortable men's dress pants trousers chinos made with high-quality fabric, perfect for both formal and casual occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Dress Pants Trousers Chinos</a></h5>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/man-blue-indego.jpg"
                                                        alt="Men's Casual Denim Jeans">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Casual Denim Jeans" data-price="PKR 5,500"
                                                            data-img="images/clothes/man-blue-indego.jpg"
                                                            data-desc="Stylish men's casual denim jeans, perfect for everyday wear and modern casual outfits.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Casual Denim
                                                            Jeans</a></h5>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img-men9.jpg" alt="Baggy Jeans">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Baggy Jeans" data-price="PKR 3,600"
                                                            data-img="images/shop/product/img-men9.jpg"
                                                            data-desc="Comfortable baggy jeans for men, perfect for casual and everyday wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img-men10.jpg" alt="Dress Pants">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Dress Pants" data-price="PKR 4,500"
                                                            data-img="images/shop/product/img-men10.jpg"
                                                            data-desc="Classic men's dress pants, tailored for comfort and a polished look, suitable for formal and office wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img-men11.jpg"
                                                        alt="Baggy Shirt & Linen Pants">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Baggy Shirt & Linen Pants"
                                                            data-price="PKR 3,600"
                                                            data-img="images/shop/product/img-men11.jpg"
                                                            data-desc="Comfortable men's baggy shirt paired with breathable linen pants, perfect for casual or home wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Baggy Shirt & Linen
                                                            Pants</a></h5>
                                                    <h5 class="price">PKR 3,600</h5>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/Men Solid Color Straight Casual.jpg"
                                                        alt="Solid Color Straight Casual Pants">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Solid Color Straight Casual Pants</a></h5>
                                                    <h5 class="price">PKR 6,800</h5>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/Khaki Straight L Pants.jpg"
                                                        alt="Khaki Straight Leg Pants">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Khaki Straight Leg Pants"
                                                            data-price="PKR 7,200"
                                                            data-img="images/clothes/Khaki Straight L Pants.jpg"
                                                            data-desc="Khaki straight leg pants for men with a comfortable and stylish look. Perfect for casual and professional settings.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6 mb-4">
                        <div class="widget widget_about">
                            ...
                            <p>FAM Fashion Hub is your ultimate destination for clothes, shoes, cosmetics, jewellery,
                                and bags. Shop the latest trends and local brands with ease!</p>
                    ...
                    <div class="col-xl-3 col-md-6 col-sm-6 mb-4">
                        <div class="widget widget_services">
                            ...
                            <p>Follow FAM Fashion Hub on social media and stay updated with the latest collections and
                                offers.</p>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 text-center text-md-start">
                        <p class="mb-0">&copy; <span class="current-year">2024</span> FAM Fashion Hub. All Rights
                            Reserved.</p>
                    </div>
                    <div class="col-md-6 text-center text-md-end">
                        <span class="me-2">We Accept:</span>
                        <img src="images/footer-img.png" alt="Payment Methods" class="img-fluid"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content p-3">
                ...
                <div class="modal-header border-0 pb-0">
                    <h5 class="modal-title" id="quickViewModalLabel">Pakistani Eastern Wear Suit</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <div class="modal-body d-flex flex-column flex-md-row gap-4">
                    <!-- Product Image -->
                    <div class="product-image flex-shrink-0" style="max-width: 300px;">
                        <img src="images/shop/product/img1.jpg" alt="Pakistani Eastern Wear Suit" id="quickViewImg"
                            class="img-fluid" style="border-radius:10px;">
                    </div>

                    <!-- Product Info -->
                    <div class="product-info flex-grow-1 d-flex flex-column gap-3" style="padding-right: 1rem;">
                        <h5 id="quickViewName">Pakistani Eastern Wear Suit</h5>

                        <!-- Price -->
                        <p id="quickViewPrice" style="font-weight: 600; margin-bottom: 0.5rem;"><strong>Price:</strong>
                            PKR 4,500</p>

                        <!-- Description -->
                        <p id="quickViewDesc" style="line-height: 1.5; margin-bottom: 1rem;">
                            Premium quality Pakistani Eastern Wear suit. Soft fabric, elegant embroidery, and perfect
                            for festive & casual occasions.
                        </p>
                        ...
                        <div class="d-flex align-items-center gap-2 mb-2">
                            ...
                            <span id="qtyValue" style="min-width: 20px; text-align: center;">1</span>
                            <button class="btn btn-outline-secondary btn-sm" id="increaseQty">+</button>
                        </div>

                        <!-- Add to Cart & Wishlist -->
                        <div class="d-flex gap-2 mb-3">
                            <a href="shop-cart.html" class="btn btn-primary flex-grow-1">Add to Cart</a>
                            <div class="bookmark-btn style-1 d-flex align-items-center gap-1">
                                <input class="form-check-input" type="checkbox" id="favoriteCheckQuickView">
                                <label class="form-check-label mb-0" for="favoriteCheckQuickView"
                        ...
                        <!-- Optional Extra Info -->
                        <div class="extra-info" style="font-size: 0.9rem; line-height:1.4;">
                            <p><strong>SKU:</strong> EW-1234</p>
                            <p><strong>Category:</strong> Pakistani best ever wear </p>
                            <p><strong>Tags:</strong> Festive, Casual</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        quickViewBtns.forEach(btn => {
            btn.addEventListener('click', function () {
                ...
                document.getElementById('quickViewModalLabel').textContent = name;
                document.getElementById('quickViewPrice').textContent = price;
                document.getElementById('quickViewImg').setAttribute('src', img);
