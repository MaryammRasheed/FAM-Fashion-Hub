                ...
                <div class="dz-bnr-inr-entry">
                    ...
                    <nav aria-label="breadcrumb" class="breadcrumb-row">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Women Clothes</li>
                        </ul>
                    </nav>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/ready women1.jpg" alt="image">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Chic Brown Traditional
                                                                    Ready-to-Wear Outfit</a>
                                                            </h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Unstitched,</a>
                                                                </li>
                                                                <li><a href="shop-with-category.html">Ready-to-Wear</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="review-num">
                                                            ...
                                                            <span><a href="javascript:void(0);"> 250 Reviews</a></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Premium quality Pakistani Eastern Wear suit. Perfect
                                                        ...
                                                        <div class="rate">
                                                            <div class="d-flex align-items-center mb-xl-3 mb-2">
                                                                <div class="meta-content m-0">
                                                                    ...
                                                                    <span class="price">PKR 4,500</span>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/ready women2.jpg" alt="image">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Elegant Black Karahi
                                                                    Embroidered Suit – Ready to Wear</a>
                                                            </h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Ready-to-Wear,</a>
                                                                </li>
                                                        ...
                                                        <div class="review-num">
                                                            ...
                                                            <span><a href="javascript:void(0);"> 650 Reviews</a></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Beautifully crafted black karahu suit featuring
                                                                    intricate embroidery for a graceful and timeless
                                                                    look.
                                                                    Perfect for festive events, dinners, and special
                                                                    occasions with comfortable premium fabric.
                                                        ...
                                                        <div class="rate">
                                                            <div class="d-flex align-items-center mb-xl-3 mb-2">
                                                                <div class="meta-content">
                                                                    <span class="price-name">Price</span>
                                                                    <span class="price">PKR 3,850</span>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/ready women3.jpg" alt="image">
                                                </div>
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Elegant Brown Karhai
                                                                    Embroidered Suit – Ready to Wear</a>
                                                            </h4>

                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Silk
                                                                        Collection,</a></li>
                                                                <li><a href="shop-with-category.html">Formal Wear</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        ...
                                                        <div class="review-num">
                                                            ...
                                                            <span><a href="javascript:void(0);"> 458 Reviews</a></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Gracefully designed brown karhai suit with delicate
                                                                    embroidery that adds a touch of sophistication.
                                                                    Perfect for festive gatherings and formal occasions,
                                                        ...
                                                        <div class="rate">
                                                            <div class="d-flex align-items-center mb-xl-3 mb-2">
                                                                <div class="meta-content">
                                                                    <span class="price-name">Price</span>
                                                                    <span class="price">PKR 6,950</span>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/ready women4.jpg" alt="image">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Elegant Mustard Karhai
                                                                    Embroidered Suit – Ready to Wear</a>
                                                            </h4>

                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Eastern Wear,</a>
                                                                </li>
                                                        ...
                                                        <div class="review-num">
                                                            ...
                                                            <span><a href="javascript:void(0);">630 Reviews</a></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Stunning mustard karhi suit featuring detailed
                                                                    embroidery for a vibrant and classy look.
                                                                    Perfect for festive occasions and daytime events
                                                                    with comfortable premium fabric and graceful design.
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="rate">
                                                            <div class="d-flex align-items-center mb-xl-3 mb-2">
                                                                <div class="meta-content">
                                                                    <span class="price-name">Price</span>
                                                                    <span class="price">PKR 4,200</span>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/ready women5.jpg" alt="image">
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Elegant Brown & Red Karhai
                                                                    Embroidered Suit – Ready to Wear</a>
                                                            </h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Women's Wear,</a>
                                                                </li>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Beautiful combination of rich brown and vibrant red
                                                                    with intricate karhai detailing for a bold, graceful
                                                                    look.
                                                                    Perfect for festive gatherings and special
                                                                    occasions, offering comfort with timeless elegance.
                                                                </p>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/ready women6-embroided.jpg" alt="image">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Women’s Elegant Embroidered
                                                                    Suit – Ready to Wear</a>
                                                            </h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Women's Wear,</a>
                                                                </li>
                                                                <li><a href="shop-with-category.html">Loungewear</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="review-num">
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Beautifully designed women’s embroidered suit
                                                                    featuring fine detailing for a graceful and refined
                                                                    look.
                                                                    Perfect for festive events, formal gatherings, and
                                                                    everyday elegance with comfortable premium fabric.
                                                                </p>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/ready-cherryfrshi.jpg" alt="image">
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Elegant Cherry Fershi
                                                                    Embroidered Suit – Ready to Wear</a>
                                                            </h4>

                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Modest Wear,</a>
                                                                </li>
                                                                <li><a href="shop-with-category.html">Abayas</a></li>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Rich cherry-toned fershi suit featuring graceful
                                                                    embroidery for a royal and timeless look.
                                                                    Perfect for festive occasions and traditional
                                                                    gatherings with comfortable, premium-quality fabric.
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="rate">
                                                            <div class="d-flex align-items-center mb-xl-3 mb-2">
                                                                <div class="meta-content">
                                                                    <span class="price-name">Price</span>
                                                                    <span class="price">PKR 6,500</span>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/frshi-shlwar.jpg" alt="image">
                                                </div>
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Elegant Fershi Shalwar
                                                                    Embroidered Suit – Ready to Wear</a>
                                                            </h4>
                                                            ...
                                                            <ul class="dz-tags">
                                                                ...
                                                                <li><a href="shop-with-category.html">Co-Ord Sets</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Beautiful fershi shalwar suit with intricate
                                                                    embroidery, offering a classy and graceful look.
                                                                    Perfect for festive occasions, formal gatherings,
                                                                    and traditional events with comfortable premium
                                                                    fabric.
                                                                </p>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row gx-xl-4 g-3 mb-xl-0 mb-md-0 mb-3">
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Chic Brown Traditional
                                                            Ready-to-Wear Outfit</a></h5>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Elegant Black Karahi
                                                            Embroidered Suit – Ready to Wear</a></h5>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Elegant Brown Karhai
                                                            Embroidered Suit – Ready to Wear</a></h5>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Elegant Mustard Karhai
                                                            Embroidered Suit – Ready to Wear</a></h5>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">legant Brown & Red Karhai
                                                            Embroidered Suit – Ready to Wear</a></h5>
                                                    <h5 class="price">PKR 4,500</h5>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Women’s Elegant
                                                            Embroidered Suit – Ready to Wear</a></h5>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Elegant Cherry Fershi
                                                            Embroidered Suit – Ready to Wear</a></h5>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Elegant Fershi Shalwar
                                                            Embroidered Suit – Ready to Wear</a></h5>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Baggy Shirt & Skirt
                                                            Co-Ord Set</a></h5>
                                                    <h5 class="price">PKR 4,500</h5>
                                                </div>
                                                <div class="product-tag">
                                ...
                                <div class="tab-pane fade active show" id="tab-list-grid" role="tabpanel"
                                    ...
                                    <div class="row gx-xl-4 g-3">
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/ready women1.jpg"
                                                        alt="Chic Brown Traditional Ready-to-Wear Outfit">
                                                    ...
                                                    <div class="shop-meta">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            data-name="Chic Brown Traditional Ready-to-Wear Outfit"
                                                            data-price="PKR 4,500"
                                                            data-img="images/clothes/ready women1.jpg"
                                                            data-desc="Beautifully designed brown ready-to-wear outfit with elegant embroidery, perfect for festive and formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/ready women2.jpg"
                                                        alt="Elegant Black Karahi Embroidered Suit – Ready to Wear">
                                                    ...
                                                    <div class="shop-meta">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Elegant Black Karahi Embroidered Suit – Ready to Wear"
                                                            data-price="PKR 3,850"
                                                            data-img="images/clothes/ready women2.jpg"
                                                            data-desc="Elegant black karahi embroidered suit designed for a classy and traditional look. Perfect for festive occasions and formal gatherings.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/ready women3.jpg"
                                                        alt="Elegant Brown Karhai Embroidered Suit – Ready to Wear">
                                                    ...
                                                    <div class="shop-meta">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Elegant Brown Karhai Embroidered Suit – Ready to Wear"
                                                            data-price="PKR 6,950"
                                                            data-img="images/clothes/ready women3.jpg"
                                                            data-desc="Elegant brown karhai embroidered suit with exquisite detailing, perfect for festive occasions and formal gatherings.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/ready women4.jpg"
                                                        alt="Elegant Mustard Karhai Embroidered Suit – Ready to Wear">
                                                    ...
                                                    <div class="shop-meta">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Elegant Mustard Karhai Embroidered Suit – Ready to Wear"
                                                            data-price="PKR 4,250"
                                                            data-img="images/clothes/ready women4.jpg"
                                                            data-desc="Elegant mustard-colored karhai embroidered suit with delicate detailing, perfect for festive occasions and formal gatherings.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/ready women5.jpg"
                                                        alt="Elegant Brown & Red Karhai Embroidered Suit – Ready to Wear">
                                                    ...
                                                    <div class="shop-meta">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Elegant Brown & Red Karhai Embroidered Suit – Ready to Wear"
                                                            data-price="PKR 4,500"
                                                            data-img="images/clothes/ready women5.jpg"
                                                            data-desc="Elegant brown and red karhai embroidered suit with intricate detailing, perfect for festive and formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Elegant Brown & Red
                                                            Karhai Embroidered Suit – Ready to Wear</a></h5>
                                                    <h5 class="price">PKR 4,500</h5>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/ready women6-embroided.jpg"
                                                        alt="Women’s Elegant Embroidered Suit – Ready to Wear">
                                                    ...
                                                    <div class="shop-meta">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Women’s Elegant Embroidered Suit – Ready to Wear"
                                                            data-price="PKR 3,500"
                                                            data-img="images/clothes/ready women6-embroided.jpg"
                                                            data-desc="Beautiful women’s embroidered suit with delicate detailing, perfect for festive and formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/ready-cherryfrshi.jpg"
                                                        alt="Elegant Cherry Fershi Embroidered Suit – Ready to Wear">
                                                    ...
                                                    <div class="shop-meta">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Elegant Cherry Fershi Embroidered Suit – Ready to Wear"
                                                            data-price="PKR 5,500"
                                                            data-img="images/clothes/ready-cherryfrshi.jpg"
                                                            data-desc="Elegant cherry fershi embroidered suit with beautiful detailing, perfect for festive and formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/frshi-shlwar.jpg"
                                                        alt="Elegant Fershi Shalwar Embroidered Suit – Ready to Wear">
                                                    ...
                                                    <div class="shop-meta">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Elegant Fershi Shalwar Embroidered Suit – Ready to Wear"
                                                            data-price="PKR 3,600"
                                                            data-img="images/clothes/frshi-shlwar.jpg"
                                                            data-desc="Elegant fershi shalwar embroidered suit with delicate detailing, perfect for festive and formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img10.jpg" alt="image">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded"
                                                            data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img12.jpg" alt="image">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Wedding Wear – Designer Collection"
                                                            data-price="PKR 14,000"
                                                            data-img="images/shop/product/img12.jpg"
                                                            data-desc="Beautiful designer wedding wear, perfect for special occasions and events.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                        <div class="btn btn-primary meta-icon dz-wishicon">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Wedding Wear – Designer
                                                            Collection</a></h5>
                                                    <h5 class="price">PKR 14,000</h5>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="modal-body d-flex flex-column flex-md-row gap-4">
                    ...
                    <div class="product-info flex-grow-1 d-flex flex-column gap-3" style="padding-right: 1rem;">
                        ...
                        <div class="extra-info" style="font-size: 0.9rem; line-height:1.4;">
                            ...
                            <p><strong>Category:</strong> Pakistani Eastern Wear, Unstitched & Ready-to-Wear</p>
                            <p><strong>Tags:</strong> Festive, Casual, Embroidery</p>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from pixio-html.vercel.app/shop-standard.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Nov 2025 05:32:25 GMT -->
