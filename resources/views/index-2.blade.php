            ...
            <div class="main-swiper2">
                <div class="container ">
                    <div class="banner-content align-items-center">
                        <div class="row">
                            <div
                                class="col-xl-7 col-lg-7 col-md-12 pt-4 align-items-center d-flex flex-column justify-content-center text-center">
                    ...
                    <div class="d-flex justify-content-center">
                        <a class="icon-button popup-youtube" href="https://www.youtube.com/watch?v=YwYoyQ1JdpQ">
                            <div class="text-row word-rotate-box border-white c-black">
                                ...
                                <svg class="badge__emoji" xmlns="http://www.w3.org/2000/svg" width="40"
                        ...
                        <div class="row gx-xl-4 g-3 mb-xl-0 mb-md-0 mb-3">
                            ...
                            <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                <div class="shop-card style-1">
                                    ...
                                    <div class="dz-content">
                                        <h5 class="title"><a href="shop-list.html">Embroidered Silk Shalwar Kameez (Green
                                                Bottom)</a></h5>
                            ...
                            <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                <div class="shop-card style-1">
                                    ...
                                    <div class="dz-content">
                                        <h5 class="title"><a href="shop-list.html">Western Wear – Casual Denim Skinny
                                                Jeans</a></h5>
                            ...
                            <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                <div class="shop-card style-1">
                                    ...
                                    <div class="dz-content">
                                        <h5 class="title"><a href="shop-list.html">Cherry Farshi Set in Oversized Fit</a>
                                        </h5>
                                        <h5 class="price">PKR 4,500</h5>
                                    </div>
                                    <div class="product-tag">
                            ...
                            <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                <div class="shop-card style-1">
                                    ...
                                    <div class="dz-content">
                                        <h5 class="title"><a href="shop-list.html">Loose Pajama Set – Soft & Breathable
                                                Fabric</a></h5>
                            ...
                            <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                <div class="shop-card style-1">
                                    ...
                                    <div class="dz-content">
                                        <h5 class="title"><a href="shop-list.html">Modest Summer Abaya – Lightweight &
                                                Breathable</a></h5>
                                        <h5 class="price">PKR 5,500</h5>
                                    </div>
                                    <div class="product-tag">
                            ...
                            <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                <div class="shop-card style-1">
                                    ...
                                    <div class="dz-content">
                                        <h5 class="title"><a href="shop-list.html">Baggy Shirt & Skirt Co-Ord Set</a>
                                        </h5>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 text-md-center m-b30 wow fadeInUp" data-wow-delay="0.2s">
                        <a class="icon-button d-md-inline-block d-none" href="blog-tag.html">
                            <div class="text-row word-rotate-box c-black border-secondary bg-secondary">
                                ...
                                <svg class="badge__emoji" xmlns="http://www.w3.org/2000/svg" width="86"
            ...
            <div class="container-fluid py-4">
                <div class="d-flex flex-wrap justify-content-center gap-3">
                    ...
                    <div class="text-center fw-bold"
                        style="background-color:#FF6F61; color:white; padding:20px 35px; border-radius:12px; min-width:140px; transition:0.3s; cursor:pointer;"
                        onmouseover="this.style.backgroundColor='#FF3B30';"
                        onmouseout="this.style.backgroundColor='#FF6F61';">Khaadi</div>

                    <div class="text-center fw-bold"
                        style="background-color:#6A5ACD; color:white; padding:20px 35px; border-radius:12px; min-width:140px; transition:0.3s; cursor:pointer;"
                        onmouseover="this.style.backgroundColor='#483D8B';"
                        onmouseout="this.style.backgroundColor='#6A5ACD';">Gul Ahmed</div>

                    <div class="text-center fw-bold"
                        style="background-color:#20B2AA; color:white; padding:20px 35px; border-radius:12px; min-width:140px; transition:0.3s; cursor:pointer;"
                        onmouseover="this.style.backgroundColor='#008B8B';"
                        onmouseout="this.style.backgroundColor='#20B2AA';">Sapphire</div>

                    <div class="text-center fw-bold"
                        style="background-color:#FFB347; color:white; padding:20px 35px; border-radius:12px; min-width:140px; transition:0.3s; cursor:pointer;"
                        onmouseover="this.style.backgroundColor='#FFA500';"
                        onmouseout="this.style.backgroundColor='#FFB347';">J.</div>

                    <div class="text-center fw-bold"
                        style="background-color:#FF69B4; color:white; padding:20px 35px; border-radius:12px; min-width:140px; transition:0.3s; cursor:pointer;"
                        onmouseover="this.style.backgroundColor='#FF1493';"
                        onmouseout="this.style.backgroundColor='#FF69B4';">Ndure</div>

                    <div class="text-center fw-bold"
                        style="background-color:#00CED1; color:white; padding:20px 35px; border-radius:12px; min-width:140px; transition:0.3s; cursor:pointer;"
                        onmouseover="this.style.backgroundColor='#20B2AA';"
                        onmouseout="this.style.backgroundColor='#00CED1';">Servics</div>

                    <div class="text-center fw-bold"
                        style="background-color:#FF4500; color:white; padding:20px 35px; border-radius:12px; min-width:140px; transition:0.3s; cursor:pointer;"
                        onmouseover="this.style.backgroundColor='#CD3700';"
                        onmouseout="this.style.backgroundColor='#FF4500';">Stylo</div>

                    <div class="text-center fw-bold"
                        style="background-color:#8A2BE2; color:white; padding:20px 35px; border-radius:12px; min-width:140px; transition:0.3s; cursor:pointer;"
                        onmouseover="this.style.backgroundColor='#4B0082';"
                        onmouseout="this.style.backgroundColor='#8A2BE2';">Limelight</div>

                    <div class="text-center fw-bold"
                        style="background-color:#3CB371; color:white; padding:20px 35px; border-radius:12px; min-width:140px; transition:0.3s; cursor:pointer;"
                        onmouseover="this.style.backgroundColor='#2E8B57';"
                        onmouseout="this.style.backgroundColor='#3CB371';">Zellbery</div>

                    <div class="text-center fw-bold"
                        style="background-color:#FF6347; color:white; padding:20px 35px; border-radius:12px; min-width:140px; transition:0.3s; cursor:pointer;"
                        onmouseover="this.style.backgroundColor='#FF4500';"
                        onmouseout="this.style.backgroundColor='#FF6347';">Shoes</div>

                    <div class="text-center fw-bold"
                        style="background-color:#1E90FF; color:white; padding:20px 35px; border-radius:12px; min-width:140px; transition:0.3s; cursor:pointer;"
                        onmouseover="this.style.backgroundColor='#104E8B';"
                        onmouseout="this.style.backgroundColor='#1E90FF';">Bags</div>

                    <div class="text-center fw-bold"
                        style="background-color:#FFD700; color:white; padding:20px 35px; border-radius:12px; min-width:140px; transition:0.3s; cursor:pointer;"
                        onmouseover="this.style.backgroundColor='#FFA500';"
