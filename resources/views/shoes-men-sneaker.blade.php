                    ...
                    <div class="dz-bnr-inr-entry">
                        ...
                        <nav aria-label="breadcrumb" class="breadcrumb-row">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">Sneakers</li>
                            </ul>
                        </nav>
                    </div>
                </div>
                                ...
                                <div class="shop-filter mt-xl-2 mt-0">
                                    <aside>
                                        ...
                                        <div class="widget widget_categories">
                                            ...
                                            <ul>
                                                <li class="cat-item cat-item-26"><a
                                                        href="shoes-men-sneaker.html">Sneakers</a> (10)</li>
                                                <li class="cat-item cat-item-36"><a href="shoes-men-sneaker.html"> Blue
                                                        LV</a> (5)</li>
                                                <li class="cat-item cat-item-43"><a href="shoes-men-sneaker.html">Brown
                                                        Sole</a> (17)</li>
                                                <li class="cat-item cat-item-27"><a href="shoes-men-sneaker.html">White
                                                        LV</a> (13)</li>
                                                <li class="cat-item cat-item-40"><a href="shoes-men-sneaker.html">Soft
                                                        Black</a> (06)</li>
                                                <li class="cat-item cat-item-40"><a href="shoes-men-sneaker.html">Light
                                                        Brown</a> (17)</li>
                                                <li class="cat-item cat-item-40"><a href="shoes-men-sneaker.html"> Beige
                                                        Sneakers</a> (13)</li>
                                                <li class="cat-item cat-item-43"><a
                                                        href="shoes-men-sneaker.html">Black</a> (06)</li>
                                                <li class="cat-item cat-item-36"><a href="shoes-men-sneaker.html">Soft
                                                        Brown</a> (22)</li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="widget widget_tag_cloud">
                                            <h6 class="widget-title">Tags</h6>
                                            <div class="tagcloud">
                                                <a href="shoes-men-sneaker.html">Sneakers </a>
                                                <a href="shoes-men-sneaker.html">Brown Sole</a>
                                                <a href="shoes-men-sneaker.html">Blue LV</a>
                                                <a href="shoes-men-sneaker.html">Black LV</a>
                                                <a href="shoes-men-sneaker.html">White Sneakers</a>

                                                <a href="shoes-men-sneaker.html">Soft Black</a>
                                                <a href="shoes-men-sneaker.html">Brown Stuff</a>
                                            </div>
                                        </div>
                                        <a href="javascript:void(0);"
    ...
    <div class="row gx-xl-4 g-3">
            ...
            <div class="shop-card style-1">
                <div class="dz-media">
                    <div class="ratio ratio-1x1">
                        <img src="images/sneaker/1 (5).jpg" alt="image">
                    </div>
                    <div class="shop-meta">
                        <div class="btn btn-primary meta-icon dz-wishicon">
                            <i class="icon feather icon-heart dz-heart"></i>
                ...
                <div class="dz-content">
                    <h5 class="title"><a href="shop-list.html">Sneakers</a></h5>
                    <h5 class="price">8,000 PKR</h5>
                </div>
                <div class="product-tag">
                    </div>
        ...
        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
            <div class="shop-card style-1">
                <div class="dz-media">
                    <div class="ratio ratio-1x1">
                        <img src="images/sneaker/1 (6).jpg" alt="image">
                    </div>
                    <div class="shop-meta">
                        <div class="btn btn-primary meta-icon dz-wishicon">
                            <i class="icon feather icon-heart dz-heart"></i>
                ...
                <div class="dz-content">
                    <h5 class="title"><a href="shop-list.html"> Green Sneakers</a></h5>
        ...
        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
            <div class="shop-card style-1">
                <div class="dz-media">
                    <div class="ratio ratio-1x1">
                        <img src="images/sneaker/1 (10).jpg" alt="image">
                    </div>
                    <div class="shop-meta">
                        <div class="btn btn-primary meta-icon dz-wishicon">
                            <i class="icon feather icon-heart dz-heart"></i>
                ...
                <div class="dz-content">
                    <h5 class="title"><a href="shop-list.html"> White </a></h5>
        ...
        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
            <div class="shop-card style-1">
                <div class="dz-media">
                    <div class="ratio ratio-1x1">
                        <img src="images/sneaker/1 (9).jpg" alt="image">
                    </div>
                    <div class="shop-meta">
                        <div class="btn btn-primary meta-icon dz-wishicon">
                            <i class="icon feather icon-heart dz-heart"></i>
        ...
        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
            <div class="shop-card style-1">
                ...
                <div class="dz-content">
                    <h5 class="title"><a href="shop-list.html">Blue Loafers </a></h5>
        ...
        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
            <div class="shop-card style-1">
                <div class="dz-media">
                    <div class="ratio ratio-1x1">
                        <img src="images/sneaker/1 (7).jpg" alt="image">
                    </div>
                    <div class="shop-meta">
                        <div class="btn btn-primary meta-icon dz-wishicon">
                            <i class="icon feather icon-heart dz-heart"></i>
        ...
        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
            <div class="shop-card style-1">
                <div class="dz-media">
                    <div class="ratio ratio-1x1">
                        <img src="images/sneaker/1 (4).jpg" alt="image">
                    </div>
                    <div class="shop-meta">
                        <div class="btn btn-primary meta-icon dz-wishicon">
                            <i class="icon feather icon-heart dz-heart"></i>
        ...
        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
            <div class="shop-card style-1">
                <div class="dz-media">
                    <div class="ratio ratio-1x1">
                        <img src="images/sneaker/1 (3).jpg" alt="image">
                    </div>
                    <div class="shop-meta">
                        <div class="btn btn-primary meta-icon dz-wishicon">
                            <i class="icon feather icon-heart dz-heart"></i>
        ...
        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
            <div class="shop-card style-1">
                <div class="dz-media">
                    <div class="ratio ratio-1x1">
                        <img src="images/sneaker/1 (2).jpg" alt="image">
                    </div>
                    <div class="shop-meta">
                        <div class="btn btn-primary meta-icon dz-wishicon">
                            <i class="icon feather icon-heart dz-heart"></i>
        ...
        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
            <div class="shop-card style-1">
                <div class="dz-media">
                    <div class="ratio ratio-1x1">
                        <img src="images/sneaker/1 (1).jpg" alt="image">
                    </div>
                    <div class="shop-meta">
                        <div class="btn btn-primary meta-icon dz-wishicon">
                            <i class="icon feather icon-heart dz-heart"></i>
