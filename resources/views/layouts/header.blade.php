            ...
            <ul class="nav navbar-nav">
                ...
                <li class="has-mega-menu cate-drop">
                    <a href="javascript:void(0);">
                        ...
                        <span>Clothes</span>
                        <span class="menu-icon"><i class="icon feather icon-chevron-right"></i></span>
                    </a>
                    <div class="mega-menu" style="width: 100%;">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-6 p-2">
                                <a href="javascript:void(0);" class="menu-title p-0 m-0">Men</a>
                                <ul>
                                    <li><a href="{{ url('/shop-standard-men') }}">T.Shirts</a></li>
                                    <li><a href="{{ url('/dress-shirts') }}">Dress Shirts</a></li>
                                    <li><a href="{{ url('/jeans-men') }}">Jeans</a></li>
                                    <li><a href="{{ url('/dress-pents-man') }}">Dress Pants</a></li>
                                    <li><a href="{{ url('/mens-kurta') }}">Kurta</a></li>
                                </ul>
                            </div>

                            <!-- Women -->
                            <div class="col-md-6 col-sm-6 col-6 p-2">
                                <a href="{{ url('/shop-standard') }}" class="menu-title p-0 m-0">Women</a>
                                <ul>
                                    <li><a href="{{ url('/shop-standard-clothes') }}">Eastern Wear</a></li>
                                    <li><a href="{{ url('/shop-standard-clothes') }}">Fusion</a></li>
                                    <li><a href="{{ url('/women-western') }}">Western Wear</a></li>
                                    <li><a href="{{ url('/ready-to-wear-women') }}">Ready to Wear</a></li>
                                    <li><a href="{{ url('/ready-to-wear-women') }}">Unstitched</a></li>
                                </ul>
                            </div>
                            ...
                            <div class="row g-0">
                                <div class="col-md-6 col-sm-6 col-6 p-2">
                                    ...
                                    <ul class="list-unstyled">
                                        <li><a href="{{ url('/shoes-men-loafer') }}">Loafer</a></li>
                                        <li><a href="{{ url('/shoes-men-sneaker') }}">Sneakers</a></li>
                                        <li><a href="{{ url('/shoes-men-brouge') }}">Brouges</a></li>
                                        <li><a href="{{ url('/shoes-men-boots') }}">Boots</a></li>
                                    </ul>
                                </div>
                                <div class="col-md-6 col-sm-6 col-6 p-2">
                                    <h6 class="fw-bold mb-2">Women</h6>
                                    <ul class="list-unstyled">
                                        <li><a href="{{ url('/shoes-women-loafer') }}">Loafer</a></li>
                                        <li><a href="{{ url('/shoes-women-heels') }}">Heels</a></li>
                                        <li><a href="{{ url('/shoes-women-flats') }}">Flat</a></li>
                                        <li><a href="{{ url('/shoes-women-boots') }}">Boots</a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="p-0 m-0">
                            <div class="row g-0">
                                <div class="col-md-6 col-sm-6 col-6 p-4">
                                    <ul class="list-unstyled">
                                        <li><a href="{{ url('/cosmetics-skincare') }}">SkinCare</a></li>
                                        <li><a href="{{ url('/cosmetics-makeup') }}">Makeup</a></li>
                                        <li><a href="{{ url('/cosmetics-haircare') }}">HairCare</a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
								...
								<ul class="sidebar-cart-list">
										...
										<div class="cart-widget">
											...
											<div class="cart-content">
												...
												<div class="d-flex align-items-center">
													...
													<h6 class="dz-price mb-0">PKR 5,500</h6>
												</div>
											</div>
										...
										<div class="cart-widget">
											...
											<div class="cart-content">
												...
												<div class="d-flex align-items-center">
													...
													<h6 class="dz-price mb-0">PKR 4,500</h6>
												</div>
											</div>
											<a href="javascript:void(0);" class="dz-close">
												<i class="ti-close"></i>
									...
									<li>
										<div class="cart-widget">
											...
											<div class="cart-content">
												<h6 class="title"><a href="product-thumbnail.html">Western Wears</a></h6>
												<div class="d-flex align-items-center">
													<div class="btn-quantity light quantity-sm me-3">
														<input type="text" value="1" name="demo_vertical2">
													</div>
										...
										<div class="cart-widget">
											...
											<div class="cart-content">
												<h6 class="title"><a href="product-thumbnail.html">Cozy Knit Cardigan
														Sweater</a></h6>
												<div class="d-flex align-items-center">
													<h6 class="dz-price  mb-0">PKR 5,600</h6>
												</div>
											</div>
											<a href="javascript:void(0);" class="dz-close">
												<i class="ti-close"></i>
										...
										<div class="cart-widget">
											...
											<div class="cart-content">
												<h6 class="title"><a href="product-thumbnail.html">Athletic Mesh Sports
														Leggings</a></h6>
												<div class="d-flex align-items-center">
													<h6 class="dz-price  mb-0">PKR 4,300</h6>
												</div>
											</div>
											<a href="javascript:void(0);" class="dz-close">
												<i class="ti-close"></i>
