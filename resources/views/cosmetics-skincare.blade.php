			...
			<section class="content-inner-3 pt-3 z-index-unset">
				<div class="container-fluid">
								...
								<div class="shop-filter mt-xl-2 mt-0">
									<aside>
										...
										<div class="widget widget_categories">
											...
											<ul>
												<li class="cat-item cat-item-26"><a
														href="cosmetics-skincare.html">Serum</a> (10)</li>
												<li class="cat-item cat-item-36"><a href="cosmetics-skincare.html"> Lip
														Balm</a> (5)</li>
												<li class="cat-item cat-item-43"><a href="cosmetics-skincare.html">Fce
														Mask</a> (17)</li>
												<li class="cat-item cat-item-27"><a href="cosmetics-skincare.html">Body
														Oil</a> (13)</li>
												<li class="cat-item cat-item-40"><a
														href="cosmetics-skincare.html">Lotion</a> (06)</li>
												<li class="cat-item cat-item-40"><a
														href="cosmetics-skincare.htmll">LipLiner</a> (17)</li>
												<li class="cat-item cat-item-40"><a href="cosmetics-skincare.html"> Face
														Ctream</a> (13)</li>
												<li class="cat-item cat-item-43"><a
														href="blog-category.html">Deodorant</a> (06)</li>
												<li class="cat-item cat-item-36"><a
														href="cosmetics-skincare.html">Mist</a> (22)</li>
											</ul>
										</div>
										...
										<div class="widget widget_tag_cloud">
											<h6 class="widget-title">Tags</h6>
											<div class="tagcloud">
												<a href="cosmetics-skincare.html">Serum </a>
												<a href="cosmetics-skincare.html">Face Mask</a>
												<a href="cosmetics-skincare.html">Exfoliator</a>
												<a href="cosmetics-skincare.html">Lotion</a>
												<a href="cosmetics-skincare.html"> Body Oil</a>
												<a href="cosmetics-skincare.html">Face Cream</a>
												<a href="cosmetics-skincare.html">Lip Balm</a>
												<a href="cosmetics-skincare.html">Eye Cream</a>
											</div>
										</div>
										<a href="javascript:void(0);"
									...
									<div class="tab-pane fade " id="tab-list-list" role="tabpanel"
										...
										<div class="row">
											<div class="col-md-12 col-sm-12 col-xxxl-6">
												<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
													<div class="shop-card style-1">
														<div class="dz-media">
															<img src="images/cosmetics/1.jpg" alt="image">
															<div class="shop-meta">
																<a href="javascript:void(0);"
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/cosmetics/2.jpg" alt="image">
														<div class="shop-meta">
															<a href="javascript:void(0);"
																class="btn btn-secondary btn-md btn-rounded"
									...
									<div class="tab-pane fade active show" id="tab-list-grid" role="tabpanel"
										...
										<div class="row gx-xl-4 g-3">
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/skincare/1.jpg" alt="image">
														<div class="shop-meta">
															<a href="javascript:void(0);"
																class="btn btn-secondary btn-md btn-rounded"
																data-bs-toggle="modal" data-bs-target="#exampleModal">
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Cleanser</a></h5>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/skincare/2.jpg" alt="image">
														<div class="shop-meta">
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Lip Balm</a></h5>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/skincare/3.jpg" alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Moisturizing
																Cream</a></h5>
														<h5 class="price">1,500 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
													</div>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media"
														...
														<img src="images/skincare/4.jpg" alt="image"
                    ...
                    <span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Eye Cream</a></h5>
														<h5 class="price">3,000 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/skincare/5.jpg" alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Scrub</a></h5>
														<h5 class="price">4,000 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
													</div>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media"
														style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
														<img src="images/skincare/7 (1).jpg" alt="image"
															style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; object-position: top;">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    <i class="fa-solid fa-eye d-md-none d-block"></i>
                    <span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Oil Cleanser</a></h5>
														<h5 class="price">2,500 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
													</div>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media"
														...
														<img src="images/skincare/7 (2).jpg" alt="image"
															style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; object-position: top;">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    <i class="fa-solid fa-eye d-md-none d-block"></i>
                    <span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Sun Screen</a></h5>
														<h5 class="price">1,800 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
													</div>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media"
														style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
														<img src="images/skincare/7 (3).jpg" alt="image"
															style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; object-position: top;">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    <i class="fa-solid fa-eye d-md-none d-block"></i>
                    <span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Body Mist</a></h5>
														<h5 class="price">2,500 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/skincare/8.jpg" alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Face Mask</a></h5>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/skincare/9.jpg" alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Serum</a></h5>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/skincare/10.jpg" alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Deodorant</a></h5>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media"
														style="position: relative; width: 100%; padding-top: 100%;">
														<img src="images/skincare/11.jpg"
															style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; object-position: top;"
															alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    ...
                    <span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Face Cream</a></h5>
														<h5 class="price">4,000 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
											...
											<div class="swiper-wrapper" id="lightgallery">
												<div class="swiper-slide">
													<div class="dz-media DZoomImage">
														<a class="mfp-link lg-item" href="images/cosmetics/1 (2).jpg"
															data-src="images/products/lady-1.png">
															<i class="feather icon-maximize dz-maximize top-right"></i>
														</a>
														<img src="images/cosmetics/1 (2).jpg" alt="image">
													</div>
												</div>
												<div class="swiper-slide">
													<div class="dz-media DZoomImage">
														<a class="mfp-link lg-item" href="images/cosmetics/1 (1).jpg"
															data-src="images/products/lady-2.png">
															<i class="feather icon-maximize dz-maximize top-right"></i>
														</a>
														<img src="images/cosmetics/1 (1).jpg" alt="image">
													</div>
												</div>
												<div class="swiper-slide">
													<div class="dz-media DZoomImage">
														<a class="mfp-link lg-item" href="images/cosmetics/1.jpg"
															data-src="iimages/cosmetics/1 (2).jpg">
															<i class="feather icon-maximize dz-maximize top-right"></i>
														</a>
														<img src="images/cosmetics/1.jpg" alt="image">
													</div>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row g-xl-4 g-3">
							<div class="col-xl-6 col-md-6">
								<img src="images/cosmetics/primer1.jpg" alt="Primer" class="img-fluid">
							</div>
							<div class="col-xl-6 col-md-6">
								<h4>Primer</h4>
								<p>Lightweight primer that smoothens skin and ensures long-lasting makeup.</p>
								<span class="price">4,500 PKR</span>
								<a href="shop-cart.html" class="btn btn-secondary">Add To Cart</a>
							</div>
						</div>
					</div>
				</div>
