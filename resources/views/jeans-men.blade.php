                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/man-blue-indego.jpg" alt="Men's T-Shirt">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's Blue Indego Jeanst</a>
                                                            </h4>
                                                            <ul class="dz-tags">
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Comfortable and stylish Men’s Jeans. Made
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/man-warm-denim.jpg" alt="Men's Jeans">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Soft and breathable cotton jeans for men, perfect
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/man-casual-long-jeans.jpg" alt="Men's Casual Jeans">
                                                </div>
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's Classic Casual Jeans</a>
                                                            </h4>

                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Csaual, lomg jeans
                                                                        Collection,</a></li>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Stylish and comfortable men's jeans made from
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/man-cozyjeans.jpg" alt="Men's cozy Jeans">
                                                </div>
                                                ...
                                                <div class="dz-content">
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Stylish and comfortable men's casual jeans made from
                                                                    soft cotton blend. Perfect for casual outings and
                                                                    semi-formal occasions.
                                                                </p>
                                                            </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/man-casual-long-jeans.jpg" alt="Men's Formal Jeans">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's Formal Jeans</a>
                                                            </h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Men's Wear,</a>
                                                                </li>
                                                                <li><a href="shop-with-category.html">Formal Jeans</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="review-num">
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Premium men's casual jeans made from soft cotton.
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/man-slim-fit-flared.jpg" alt="Men's Casual Jeans">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's loose Pajama – Soft &
                                                                    Breathable Fabric</a>
                                                            </h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Men's Wear,</a>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Ultra-comfortable men's Jeans crafted from
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/man-vintage-faded-jeans.jpg" alt="Men's Jeans">
                                                </div>
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's Vintage faded jeans
age Faded Jeans</a>
                                                                </a>
                                                            </h4>
                                                            ...
                                                            <ul class="dz-tags">
                                                                ...
                                                                <li><a href="shop-with-category.html">Casual Jeans</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Comfortable men's casual denim jeans designed for
                                                                    daily wear. Soft stretch denim
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/clothes/man-slim-fit-flared.jpg" alt="Men's Slim Fit Flared Jeans">
                                                </div>
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's Slim Fit Flared Jeans</a>
                                                            </h4>
                                    ...
                                    <div class="row gx-xl-4 g-3 mb-xl-0 mb-md-0 mb-3">
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media" div
                                                    ...
                                                    <img src="images/clothes/man-blue-indego.jpg" alt="image" style="position: absolute; top: 0; left: 0; width: 100%;
																		 height: 100%; object-fit: cover; object-position: top;">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Mans Blue Indego Jeans"
                                                            data-price="PKR 6,800"
                                                            data-img="images/clothes/man-blue-indego.jpg"
                                                            data-desc="Beautiful men’s blue indego jeans with elegant look and comfortable fit. Perfect for casual and trendy looks.">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's blue indego jeans</a>
                                                    </h5>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media" div
                                                    style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
                                                    <img src="images/clothes/man-casual-long-jeans.jpg" alt="image" style="position: absolute; top: 0; left: 0; width: 100%;
																		 height: 100%; object-fit: cover; object-position: top;">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Mans Casual Long Jeans"
                                                            data-price="PKR 3,850"
                                                            data-img="images/clothes/man-casual-long-jeans.jpg"
                                                            data-desc="Beautiful men’s casual long jeans with comfortable fit and stylish design. Perfect for everyday wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                        <div class="btn btn-primary meta-icon dz-wishicon">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Premium casual long jeans</a></h5>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media" div
                                                    style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
                                                    <img src="images/clothes/man-cozyjeans.jpg" alt="image" style="position: absolute; top: 0; left: 0; width: 100%;
																		 height: 100%; object-fit: cover; object-position: top;">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Mans Cozy wear jeans elegent look"
                                                            data-price="PKR 3,500"
                                                            data-img="images/clothes/man-cozyjeans.jpg"
                                                            data-desc="Beautiful men’s cozy jeans with elegant look and comfortable fit. Perfect for casual and semi-formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                        <div class="btn btn-primary meta-icon dz-wishicon">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's cozy jeans</a></h5>
                                                    <h5 class="price">PKR 2,950</h5>
                                                </div>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media" div
                                                    style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
                                                    <img src="images/clothes/man-slim-fit-flared.jpg" alt="image" style="position: absolute; top: 0; left: 0; width: 100%;
																		 height: 100%; object-fit: cover; object-position: top;">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Slim Fit Flared Jeans"
                                                            data-price="PKR 4,250"
                                                            data-img="images/clothes/man-slim-fit-flared.jpg"
                                                            data-desc="Slim fit flared jeans for men with a comfortable and stylish look. Perfect for casual and semi-formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                        <div class="btn btn-primary meta-icon dz-wishicon">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Slim Fit Flared Jeans</a></h5>
                                                ...
                                                <div class="dz-media" div
                                                    ...
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Casual Long Jeans"
                                                            data-price="PKR 4,500"
                                                            data-img="images/clothes/man-casual-long-jeans.jpg"
                                                            data-desc="Casual long jeans for men with a comfortable and stylish look. Perfect for everyday wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                        <div class="btn btn-primary meta-icon dz-wishicon">
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media"
                                                    style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
                                                    <img src="images/clothes/man-warm-denim.jpg" alt="image" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;
                                                    ...
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Warm Denim Jeans"
                                                            data-price="PKR 3,500"
                                                            data-img="images/clothes/man-warm-denim.jpg"
                                                            data-desc="Warm denim jeans for men with a comfortable and stylish look. Perfect for everyday wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media"
                                                  style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
                                                    <img src="images/clothes/man-casual-long-jeans.jpg" alt="image" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;
                                                                   object-fit: cover; object-position: top;">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                    ...
                                    <div class="row gx-xl-4 g-3">
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    ...
                                                    <div class="shop-meta">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Casual blue indego" data-price="PKR 4,500"
                                                            data-img="images/clothes/man-blue-indego.jpg"
                                                            data-desc="Stylish and comfortable men's casual jeans, perfect for daily wear and casual outings. Made from soft, breathable fabric.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Casual Jeans</a>
                                                    </h5>
                                                    <h5 class="price">PKR 4,500</h5>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/man-cozyjeans.jpg"
                                                        alt="Men's Premium Cotton T-Shirt">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Premium Cotton T-Shirt"
                                                            data-price="PKR 3,850"
                                                            data-img="images/clothes/man-cozyjeans.jpg"
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/man-slim-fit-flared.jpg"
                                                        alt="Men's Slim Fit Flared Jeans">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Slim Fit Flared Jeans" data-price="PKR 6,950"
                                                            data-img="images/clothes/man-slim-fit-flared.jpg"
                                                            data-desc="Premium men's slim fit flared jeans crafted with soft, breathable fabric. Perfect for casual or semi-formal wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/man-casual-long-jeans.jpg"
                                                    ...
                                                    <div class="shop-meta">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Casual Denim Long Jeans"
                                                            data-price="PKR 4,250"
                                                            data-img="images/clothes/man-casual-long-jeans.jpg"
                                                            data-desc="Classic denim long jeans for men, perfect for casual western wear outfits.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Casual Long Jeans</a>
                                                    </h5>
                                                    <h5 class="price">PKR 4,250</h5>
                                                </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/man-warm-denim.jpg"
                                                        alt="Men's Warm Denim Jeans">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Warm Denim Jeans" data-price="PKR 4,500"
                                                            data-img="images/clothes/man-warm-denim.jpg"
                                                            data-desc="Premium men's warm denim jeans, perfect for casual and semi-formal wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Warm Denim Jeans</a></h5>
                                                    <h5 class="price">PKR 4,500</h5>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img-men7.jpg"
                                                        alt="Men's Loose Pajama Set">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Loose Pajama Set – Soft & Breathable Fabric"
                                                            data-price="PKR 3,500"
                                                            data-img="images/shop/product/img-men7.jpg"
                                                            data-desc="Comfortable men's loose pajama set made with soft and breathable fabric, ideal for home or casual wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Loose Pajama Set –
                                                            Soft & Breathable Fabric</a></h5>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img-men8.png"
                                                    ...
                                                    <div class="shop-meta">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            data-img="images/shop/product/img-men8.png"
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/man-vintage-faded-jeans.jpg"
                                                        alt="Vintage Faded Jeans">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Vintage Faded Jeans"
                                                            data-price="PKR 5,200"
                                                            data-img="images/clothes/man-vintage-faded-jeans.jpg"
                                                            data-desc="Stunning men's vintage faded jeans perfect for casual and trendy looks.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Vintage Faded Jeans</a></h5>
                                                    <h5 class="price">PKR 5,200</h5>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/man-blue-indego.jpg"
                                                        alt="Blue Indego Jeans">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Blue Indego Jeans"
                                                            data-price="PKR 6,800"
                                                            data-img="images/clothes/man-blue-indego.jpg"
                                                            data-desc="Stunning men's blue indiego jeans perfect for casual and trendy looks.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Blue Indego Jeans</a></h5>
