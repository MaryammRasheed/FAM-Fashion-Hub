                                ...
                                <div class="tab-pane fade active show" id="tab-list-grid" role="tabpanel"
                                    ...
                                    <div class="row gx-xl-4 g-3">
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/white-kurta.jpg"
                                                        alt="Men's white Kurta">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's White Kurta" data-price="PKR 4,250"
                                                            data-img="images/clothes/white-kurta.jpg"
                                                            data-desc="A stylish white kurta perfect for formal or semi-formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's White Kurta</a>
                                                    </h5>
                                                    <h5 class="price">PKR 4,250</h5>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/green-kurta.jpg"
                                                        alt="Men's Premium Green Kurta">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Premium Cotton Green Kurta"
                                                            data-price="PKR 3,850"
                                                            data-img="images/clothes/green-kurta.jpg"
                                                            data-desc="Traditional Pakistani Eastern short shirt styled as a premium green kurta. Comfortable and perfect for casual or semi-formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/blue-kurta.jpg"
                                                        alt="Men's Classic blue kurta">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Classic Blue Kurta" data-price="PKR 4,250"
                                                            data-img="images/clothes/blue-kurta.jpg"
                                                            data-desc="Premium men's classic blue kurta crafted with soft, breathable fabric. Perfect for casual or semi-formal wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Classic Blue Kurta</a></h5>
                                                    <h5 class="price">PKR 4,250</h5>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/baby-pink-kurta.jpg"
                                                        alt="Men's Baby Pink Kurta">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Baby Pink Kurta"
                                                            data-price="PKR 4,250"
                                                            data-img="images/clothes/baby-pink-kurta.jpg"
                                                            data-desc="Classic baby pink kurta for men, perfect for casual or semi-formal wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Baby Pink Kurta</a>
                                                    </h5>
                                                    <h5 class="price">PKR 4,250</h5>
                                                </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/black-kurta.jpg"
                                                        alt="Men's Formal Black Kurta">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Formal Black Kurta" data-price="PKR 4,500"
                                                            data-img="images/clothes/black-kurta.jpg"
                                                            data-desc="Premium men's formal black kurta, perfect for office wear, events, and formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Formal Black Kurta</a></h5>
                                                    <h5 class="price">PKR 4,500</h5>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/maroon-kurta.jpg"
                                                        alt="Men's Maroon Formal Kurta">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Maroon Formal Kurta"
                                                            data-price="PKR 4,500"
                                                            data-img="images/clothes/maroon-kurta.jpg"
                                                            data-desc="Classic maroon formal kurta for men, perfect for professional or formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Maroon Formal Kurta –
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/black kurta-pjama.jpg"
                                                        alt="Men's Black Kurta-Pjama">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Black Kurta-Pjama" data-price="PKR 4,500"
                                                            data-img="images/clothes/black kurta-pjama.jpg"
                                                            data-desc="Classic black kurta-pjama for men, perfect for professional or formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Black Kurta-Pjama</a></h5>
                                                    <h5 class="price">PKR 4,500</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/purple-kurta.jpg" alt="Plain Casual Shirt">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Purple Embroided Kurta" data-price="PKR 3,600"
                                                            data-img="images/clothes/purple-kurta.jpg"
                                                            data-desc="Comfortable purple embroidered kurta for men, perfect for casual and everyday wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Plain Green Kurta</a></h5>
                                                    <h5 class="price">PKR 3,600</h5>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/white-kurta.jpg" alt="Dress Shirt">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's White Kurta" data-price="PKR 4,500"
                                                            data-img="images/clothes/white-kurta.jpg"
                                                            data-desc="Classic men's white kurta, tailored for comfort and a polished look, suitable for formal and office wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/purple-kurta.jpg"
                                                        alt="Purple Embrioded Kurta">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Purple Embroided Kurta"
                                                            data-price="PKR 3,600"
                                                            data-img="images/clothes/purple-kurta.jpg"
                                                            data-desc="Comfortable men's purple embroidered kurta, perfect for formal and festive occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's White Kurta</a></h5>
                                                    <h5 class="price">PKR 4,500</h5>
                                                </div>
                                            </div>
                                        </div>
