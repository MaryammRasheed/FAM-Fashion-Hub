                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img-men1.jpg" alt="Men's T-Shirt">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's Casual T-Shirt</a>
                                                            </h4>
                                                            <ul class="dz-tags">
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Comfortable and stylish Men’s casual T-Shirt. Made
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img-men2.jpg" alt="Men's T-Shirt">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Soft and breathable cotton T-shirt for men, perfect
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img-men4.jpg" alt="Men's Polo Shirt">
                                                </div>
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's Classic Polo Shirt</a>
                                                            </h4>

                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Polo
                                                                        Collection,</a></li>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Stylish and comfortable men's polo shirt made from
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img-men5.jpg" alt="Men's Polo Shirt">
                                                </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img-men6.jpg" alt="Men's Dress Shirt">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's Formal Dress Shirt</a>
                                                            </h4>
                                                            <ul class="dz-tags">
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Premium men's dress shirt made from soft cotton.
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img-men7.jpg" alt="Men's Dress Shirt">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Ultra-comfortable men's dress shirt crafted from
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img-men8.png" alt="Men's Jeans">
                                                </div>
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's Casual Denim Jeans</a>
                                                            </h4>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img-men12.jpg" alt="Men's Kurta">
                                                </div>
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Men's Traditional Kurta</a>
                                                            </h4>
                                    ...
                                    <div class="row gx-xl-4 g-3 mb-xl-0 mb-md-0 mb-3">
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media" div
                                                    ...
                                                    <img src="images/clothes/maroondress-shirt.jpg" alt="image" style="position: absolute; top: 0; left: 0; width: 100%;
																		 height: 100%; object-fit: cover; object-position: top;">
                                                    <div class="shop-meta">
                                                       <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Maroon Dress Shirt"
                                                            data-price="PKR 4,250"
                                                            data-img="images/clothes/maroondress-shirt.jpg"
                                                            data-desc="Elegant men's maroon dress shirt with a classic fit, perfect for formal or business occasions.">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Maroon Dress Shirt</a>
                                                    </h5>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media" div
                                                    style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
                                                    <img src="images/clothes/black shirt.jpg" alt="image" style="position: absolute; top: 0; left: 0; width: 100%;
																		 height: 100%; object-fit: cover; object-position: top;">
                                                    <div class="shop-meta">
                                                       <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's black Dress Shirt"
                                                            data-price="PKR 4,250"
                                                            data-img="images/clothes/black shirt.jpg"
                                                            data-desc="A stylish black dress shirt perfect for formal or semi-formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                        <div class="btn btn-primary meta-icon dz-wishicon">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Black Dress Shirt</a></h5>
                                                    <h5 class="price">PKR 4,250</h5>
                                                </div>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media" div
                                                    style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
                                                    <img src="images/shop/product/img-men4.jpg" alt="image" style="position: absolute; top: 0; left: 0; width: 100%;
																		 height: 100%; object-fit: cover; object-position: top;">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Classic Polo
                                                            Shirt</a></h5>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media" div
                                                    style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
                                                    <img src="images/shop/product/img-men5.jpg" alt="image" style="position: absolute; top: 0; left: 0; width: 100%;
																		 height: 100%; object-fit: cover; object-position: top;">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded"
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media" div
                                                    style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
                                                    <img src="images/shop/product/img-men6.jpg" alt="image" style="position: absolute; top: 0; left: 0; width: 100%;
																		 height: 100%; object-fit: cover; object-position: top;">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded"
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Formal Dress
                                                            Shirt</a></h5>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media"
                                                    style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
                                                    <img src="images/shop/product/img-men7.jpg" alt="image" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's loose Pajama – Soft
                                                            & Breathable Fabric</a></h5>
                                ...
                                <div class="tab-pane fade active show" id="tab-list-grid" role="tabpanel"
                                    ...
                                    <div class="row gx-xl-4 g-3">
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/maroondress-shirt.jpg"
                                                        alt="Men's maroon Dress Shirt">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Maroon Dress Shirt" data-price="PKR 4,250"
                                                            data-img="images/clothes/black dress shirt.jpg"
                                                            data-desc="A stylish maroon dress shirt perfect for formal or semi-formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Casual T-Shirt</a>
                                                    </h5>
                                                    <h5 class="price">PKR 4,500</h5>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/black shirt.jpg"
                                                    ...
                                                    <div class="shop-meta">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Premium Cotton black T-shirt"
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/The Bentley Striped Shirt.jpg"
                                                        alt="Men's Classic Polo Shirt">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Classic Polo Shirt" data-price="PKR 6,950"
                                                            data-img="images/clothes/The Bentley Striped Shirt.jpg"
                                                            data-desc="Premium men's classic polo shirt crafted with soft, breathable fabric. Perfect for casual or semi-formal wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Bentlay Dress Shirt</a></h5>
                                                    <h5 class="price">PKR 4,250</h5>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/Men Solid Color Straight Casual.jpg"
                                                        alt="Western Wear – Casual straight shirt">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Casual Straight Shirt"
                                                            data-price="PKR 4,250"
                                                            data-img="images/clothes/Men Solid Color Straight Casual.jpg"
                                                            data-desc="Classic straight casual shirt for men, perfect for western wear outfits.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Casual Shirt</a>
                                                    </h5>
                                                    <h5 class="price">PKR 4,250</h5>
                                                </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img-men6.jpg"
                                                    ...
                                                    <div class="shop-meta">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Formal Dress Shirt" data-price="PKR 4,500"
                                                            data-img="images/shop/product/img-men6.jpg"
                                                            data-desc="Premium men's formal dress shirt, perfect for office wear, events, and formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/Men's Black Striped Formal Shirt.jpg"
                                                        alt="Men's Black Striped Formal Shirt">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Black Striped Formal Shirt"
                                                            data-price="PKR 4,500"
                                                            data-img="images/clothes/Men's Black Striped Formal Shirt.jpg"
                                                            data-desc="Classic black striped formal shirt for men, perfect for professional or formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Black Striped Formal Shirt –
                                                            Classic & Stylish</a></h5>
                                                    <h5 class="price">PKR 4,500</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/Mens Dress Shirts Stretch Slim.jpg"
                                                        alt="Men's Dress Stripped  Formal Shirt">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Dress Stripped Formal Shirt" data-price="PKR 4,500"
                                                            data-img="images/clothes/Mens Dress Shirts Stretch Slim.jpg"
                                                            data-desc="Classic men's dress striped formal shirt for men, perfect for professional or formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Black Striped Formal Shirt</a></h5>
                                                    <h5 class="price">PKR 4,500</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/Men's Plain Casual shirt.jpg" alt="Plain Casual Shirt">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Plain Casual Shirt" data-price="PKR 3,600"
                                                            data-img="images/clothes/Men's Plain Casual shirt.jpg"
                                                            data-desc="Comfortable plain casual shirt for men, perfect for casual and everyday wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Plain Casual Shirt</a></h5>
                                                    <h5 class="price">PKR 3,600</h5>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/clothes/Mens Dress Shirts Stretch Slim.jpg" alt="Dress Shirt">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Dress Shirt" data-price="PKR 4,500"
                                                            data-img="images/clothes/Mens Dress Shirts Stretch Slim.jpg"
                                                            data-desc="Classic men's dress shirt, tailored for comfort and a polished look, suitable for formal and office wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Dress Shirt</a>
                                                    </h5>
                                                    <h5 class="price">PKR 4,500</h5>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img-men12.jpg"
                                                        alt="Wedding Wear – Elegant Kurta">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Men's Wedding Wear – Elegant Kurta"
                                                            data-price="PKR 12,500"
                                                            data-img="images/shop/product/img-men12.jpg"
                                                            data-desc="Stunning men's wedding kurta perfect for ceremonies, receptions, and formal events.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Men's Wedding Wear –
                                                            Elegant Kurta</a></h5>
                                                    <h5 class="price">PKR 12,500</h5>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img-men13.jpg"
                                                        alt="Wedding Wear – Elegant Kurta">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            data-name="Men's Wedding Wear – Elegant Kurta"
                                                            data-price="PKR 12,500"
                                                            data-img="images/shop/product/img-men13.jpg"
                                                            data-desc="Stunning men's wedding kurta perfect for ceremonies, receptions, and formal events.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
