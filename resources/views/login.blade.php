					 ...
					 <div class="login-area">
						...
						<form>
							...
							<div class="text-center">
								<a href="account-dashboard.html" class="btn btn-secondary btnhover text-uppercase me-2 sign-btn">Sign In</a>
								<a href="registration.html" class="btn btn-outline-secondary btnhover text-uppercase">Register</a>
							</div>
						</form>
					</div> 
				</div>
...
<!-- Mirrored from pixio-html.vercel.app/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Nov 2025 05:33:11 GMT -->
</html>