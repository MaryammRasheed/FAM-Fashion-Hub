...
<li class="has-mega-menu sub-menu-down" style="position:relative;">
								...
								<div class="tab-pane fade show active" id="shopping-cart-pane" role="tabpanel"
									...
									<div class="shop-sidebar-cart">
										<ul class="sidebar-cart-list">
											<li>
												<div class="cart-widget">
													...
													<div class="cart-content">
														<h6 class="title"><a href="product-thumbnail.html">Sophisticated
																Swagger Suit</a></h6>
											...
											<li>
												<div class="cart-widget">
													...
													<div class="cart-content">
														<h6 class="title"><a href="product-thumbnail.html">Cozy Knit
											...
											<li>
												<div class="cart-widget">
													...
													<div class="cart-content">
														<h6 class="title"><a href="product-thumbnail.html">Athletic Mesh
										...
										<div class="mt-auto">
											...
											<a href="shop-checkout-makeup.html"
												class="btn btn-outline-secondary btn-block m-b20">Checkout</a>
											<a href="shop-cart-makeup.html" class="btn btn-secondary btn-block">View
												Cart</a>
										</div>
									</div>
								</div>
					...
					<div class="dz-bnr-inr-entry">
						...
						<nav aria-label="breadcrumb" class="breadcrumb-row">
							<ul class="breadcrumb">
								...
								<li class="breadcrumb-item">Cosmetics</li>
							</ul>
						</nav>
					</div>
				</div>
			...
			<section class="content-inner-3 pt-3 z-index-unset">
				<div class="container-fluid">
								...
								<div class="shop-filter mt-xl-2 mt-0">
									<aside>
										...
										<div class="widget widget_categories">
											...
											<ul>
												<li class="cat-item cat-item-26"><a
														href="cosmetics-skincare.html">Primer</a> (10)</li>
												<li class="cat-item cat-item-36"><a href="cosmetics-skincare.html">
														Foundation</a> (5)</li>
												<li class="cat-item cat-item-43"><a
														href="cosmetics-skincare.html">Eyeliner</a> (17)</li>
												<li class="cat-item cat-item-27"><a
														href="cosmetics-skincare.html">LipStick</a> (13)</li>
												<li class="cat-item cat-item-40"><a
														href="cosmetics-skincare.html">EyeShadow</a> (06)</li>
												<li class="cat-item cat-item-40"><a
														href="cosmetics-skincare.htmll">LipLiner</a> (17)</li>
												<li class="cat-item cat-item-40"><a href="cosmetics-skincare.html">
														Mascara</a> (13)</li>
												<li class="cat-item cat-item-43"><a href="blog-category.html">Eye
														Shadow</a> (06)</li>
												<li class="cat-item cat-item-36"><a
														href="cosmetics-skincare.html">Bronzer</a> (22)</li>
											</ul>
										</div>
										...
										<div class="widget widget_tag_cloud">
											<h6 class="widget-title">Tags</h6>
											<div class="tagcloud">
												<a href="cosmetics-skincare.html">LipStick </a>
												<a href="cosmetics-skincare.html">MakeUp Brushes</a>
												<a href="cosmetics-skincare.html">Sponge</a>
												<a href="cosmetics-skincare.html">Lotion</a>
												<a href="cosmetics-skincare.html">Lip gloss</a>
												<a href="cosmetics-skincare.html">Face Cream</a>
												<a href="cosmetics-skincare.html">Powder Puff</a>
												<a href="cosmetics-skincare.html">EyeLash Curler</a>
											</div>
										</div>
										<a href="javascript:void(0);"
									...
									<div class="tab-pane fade " id="tab-list-list" role="tabpanel"
										...
										<div class="row">
											<div class="col-md-12 col-sm-12 col-xxxl-6">
												<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
													<div class="shop-card style-1">
														<div class="dz-media">
															<img src="images/makeup/1.jpg" alt="image">
															<div class="shop-meta">
																<a href="javascript:void(0);"
																...
																<div class="btn btn-primary meta-icon dz-wishicon">
																	...
																	<i
																		class="icon feather icon-heart-on dz-heart-fill"></i>
																</div>
														...
														<div class="dz-content">
															<h5 class="title"><a href="shop-list.html">Primer</a></h5>
															<h5 class="price">8,000 PKR</h5>
														</div>
												...
												<div class="shop-card style-1">
													<div class="dz-media">
														...
														<div class="shop-meta">
															<a href="javascript:void(0);"
																class="btn btn-secondary btn-md btn-rounded"
																data-bs-toggle="modal" data-bs-target="primerModal">
																<i class="fa-solid fa-eye d-md-none d-block"></i>
																<span class="d-md-block d-none">Quick View</span>
															</a>
															<div class="btn btn-primary meta-icon dz-wishicon">
														...
														<div class="dz-header">
															<div>
																<h4 class="title mb-0"><a href="shop-list.html">Classic
																		Denim Skinny Jeans</a></h4>
																<ul class="dz-tags">
																	<li><a
																			href="shop-with-category.html">Accessories,</a>
																	</li>
																	<li><a href="shop-with-category.html">Sunglasses</a>
																	</li>
																</ul>
															</div>
															<div class="review-num">
																...
																<span><a href="javascript:void(0);"> 458
																		Review</a></span>
															</div>
														</div>
														<div class="dz-body">
													...
													<div class="dz-content">
														<div class="dz-header">
															...
															<div class="review-num">
																...
																<span><a href="javascript:void(0);"> 630
																		Review</a></span>
															</div>
														</div>
														<div class="dz-body">
													...
													<div class="dz-content">
														<div class="dz-header">
															...
															<div class="review-num">
																...
																<span><a href="javascript:void(0);"> 520
																		Review</a></span>
															</div>
														</div>
														<div class="dz-body">
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/makeup/2.jpg" alt="image">
														<div class="shop-meta">
															<a href="javascript:void(0);"
																class="btn btn-secondary btn-md btn-rounded"
													...
													<div class="dz-content">
														<div class="dz-header">
															...
															<div class="review-num">
																...
																<span><a href="javascript:void(0);"> 776
																		Review</a></span>
															</div>
														</div>
														<div class="dz-body">
														...
														<div class="dz-header">
															<div>
																<h4 class="title mb-0"><a
																		href="shop-list.html">Water-Resistant
															...
															<div class="review-num">
																...
																<span><a href="javascript:void(0);"> 255
																		Review</a></span>
															</div>
														</div>
														<div class="dz-body">
										...
										<div class="row gx-xl-4 g-3">
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">LipStick</a></h5>
														<h5 class="price">8,000 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/makeup/2.jpg" alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="modal-primer">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
														</a> -->
															<div class="btn btn-primary meta-icon dz-wishicon">
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/makeup/3.jpg" alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">EyeShadow</a></h5>
														<h5 class="price">9,000 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
													</div>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media"
														...
														<img src="images/makeup/4.jpg" alt="image"
                    ...
                    <span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Mascara</a></h5>
														<h5 class="price">3,000 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
													</div>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/makeup/5.jpg" alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Foundation</a></h5>
														<h5 class="price">7,000 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
													</div>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media"
														style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
														<img src="images/makeup/6.jpg" alt="image"
															style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; object-position: top;">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    <i class="fa-solid fa-eye d-md-none d-block"></i>
                    <span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Highlighter</a></h5>
														<h5 class="price">2,000 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
													</div>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media"
														...
														<img src="images/makeup/8 (1).jpg" alt="image"
															style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; object-position: top;">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    <i class="fa-solid fa-eye d-md-none d-block"></i>
                    <span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">EyeLiner</a></h5>
														<h5 class="price">1,000 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
													</div>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media"
														style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
														<img src="images/makeup/9.jpg" alt="image"
															style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; object-position: top;">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    <i class="fa-solid fa-eye d-md-none d-block"></i>
                    <span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">LipGloss</a></h5>
														<h5 class="price">500 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
													</div>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/makeup/10.jpg" alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Bronzer</a></h5>
														<h5 class="price">900 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
													</div>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/makeup/11 (1).jpg" alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Blush</a></h5>
														<h5 class="price">1,1000 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
													</div>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/makeup/12 (1).jpg" alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Concealer</a></h5>
														<h5 class="price">700 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
													</div>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media"
														style="position: relative; width: 100%; padding-top: 100%;">
														<img src="images/makeup/13 (1).jpg"
															style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; object-position: top;"
															alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    ...
                    <span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Lip Liner</a></h5>
														<h5 class="price">400 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
													</div>
	...
	<!-- Footer End -->
											...
											<div class="swiper-wrapper" id="lightgallery">
												<div class="swiper-slide">
													<div class="dz-media DZoomImage">
														<a class="mfp-link lg-item" href="images/makeup/1 (2).jpg"
															data-src="images/products/lady-1.png">
															<i class="feather icon-maximize dz-maximize top-right"></i>
														</a>
														<img src="images/makeup/1 (2).jpg" alt="image">
													</div>
												</div>
												<div class="swiper-slide">
													<div class="dz-media DZoomImage">
														<a class="mfp-link lg-item" href="images/makeup/1 (1).jpg"
															data-src="images/products/lady-2.png">
															<i class="feather icon-maximize dz-maximize top-right"></i>
														</a>
														<img src="images/makeup/1 (1).jpg" alt="image">
													</div>
												</div>
												<div class="swiper-slide">
													<div class="dz-media DZoomImage">
														<a class="mfp-link lg-item" href="images/makeup/1.jpg"
															data-src="iimages/makeup/1 (2).jpg">
															<i class="feather icon-maximize dz-maximize top-right"></i>
														</a>
														<img src="images/makeup/1.jpg" alt="image">
													</div>
									...
									<div class="dz-content">
										<div class="dz-content-footer">
											<div class="dz-content-start">
												...
												<h4 class="title mb-1"><a href="shop-standard.html">Lip Stick</a></h4>
												<div class="review-num">
										...
										<p class="para-text">
											Smooth, creamy lipstick that delivers rich,
											vibrant color and long-lasting wear for a flawless finish
										</p>
										<div class="meta-content m-b20 d-flex align-items-end">
											<div class="me-3">
												<span class="form-label">Price</span>
												<span class="price">8,000 PKR </span>
											</div>
										...
										<div class=" cart-btn">
											<a href="shop-cart-makeup.html" class="btn btn-secondary text-uppercase">Add
												To Cart</a>
										...
										<div class="dz-info mb-0">
											...
											<ul>
												...
												<li class="cat-item cat-item-26"><a
														href="cosmetics-skincare.html">Primer</a> </li>
												<li class="cat-item cat-item-36"><a href="cosmetics-skincare.html">
														Foundation</a> </li>
												<li class="cat-item cat-item-43"><a
														href="cosmetics-skincare.html">Eyeliner</a> </li>
												<li class="cat-item cat-item-27"><a
														href="cosmetics-skincare.html">LipStick</a> </li>
												<li class="cat-item cat-item-40"><a
														href="cosmetics-skincare.html">EyeShadow</a> </li>
												<li class="cat-item cat-item-40"><a
														href="cosmetics-skincare.html">LipLiner</a> x</li>
												<!-- <li class="cat-item cat-item-40"><a href="cosmetics-skincare.html"> Mascara</a> (13)</li> 											 -->
											</ul>
											<ul>
												<li><strong>Tags:</strong></li>
												<li><a href="cosmetics-skincare.html">Lip Liner</a></li>
												<li><a href="cosmetics-skincare.html">Mascara,</a></li>
												<li><a href="cosmetics-skincare.html">Eye Shadow,</a></li>
												<li><a href="cosmetics-skincare.html">LipStick</a></li>
											</ul>
											<div class="dz-social-icon">
												<ul>
		...
		<!-- modal 2 -->
		<div class="modal quick-view-modal fade" id="primerModal" tabindex="-1" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
						<i class="icon feather icon-x"></i>
					...
					<div class="modal-body">
						...
						<div class="row g-xl-4 g-3">
							<div class="col-xl-6 col-md-6">
								<img src="images/makeup/primer1.jpg" alt="Primer" class="img-fluid">
							</div>
							<div class="col-xl-6 col-md-6">
								<h4>Primer</h4>
								<p>Lightweight primer that smoothens skin and ensures long-lasting makeup.</p>
								<span class="price">4,500 PKR</span>
								<a href="shop-cart-makeup.html" class="btn btn-secondary">Add To Cart</a>
							</div>
						</div>
					</div>
				</div>
