                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/clothes/img1-western.jpg" alt="image">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html"> Stylish Western Top & Bottom
                                                                    set made with soft and breathable fabric</a>
                                                            </h4>
                                                            <ul class="dz-tags">
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Premium quality Pakistani Western Wear suit. Perfect
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/clothes/img2-knetted sweater.webp"
                                                        alt="image">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Chic Knitted Sweater Set</a>
                                                            </h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Ready-to-Wear,</a>
                                                                </li>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Stay cozy in this soft, premium-knit sweater —
                                                                    perfect for winter vibes and casual elegance.
                                                                    Perfect for casual and semi-formal wear throughout
                                                                    the season.
                                                                </p>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/clothes/img3-turtlenect sweater.webp"
                                                        alt="image">
                                                </div>
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Elegant Turtleneck Sweater</a>
                                                            </h4>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Snuggle up in this soft, high-quality turtleneck
                                                                    sweater — ideal for chilly days with a touch of
                                                                    classic style.
                                                                </p>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/clothes/img4-tieweist.webp"
                                                        alt="image">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Western Wear – Chic Tie-Waist
                                                                    Dress</a>
                                                            </h4>

                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Western Wear,</a>
                                                                </li>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Flatter your figure with this elegant tie-waist
                                                                    dress, crafted for comfort and effortless style —
                                                                    perfect for casual outings or brunch dates.
                                                                </p>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/clothes/img5-sweaterjeans.jpg"
                                                        alt="image">
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Casual Sweater & Jeans Set</a>
                                                            </h4>
                                                            <ul class="dz-tags">
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Effortless style meets comfort with this cozy
                                                                    sweater paired with classic jeans — perfect for
                                                                    everyday outings and casual vibes.
                                                                </p>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/clothes/img7-swearr.png" alt="image">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">LCozy Chic Sweater</a>
                                                            </h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Women's Wear,</a>
                                                                </li>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    Stay warm and stylish with this soft, premium-knit
                                                                    sweater — perfect for casual days and cozy winter
                                                                    vibes.
                                                                </p>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="dz-shop-card style-2">
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Modest Summer Abaya –
                                                                    Lightweight & Breathable</a>
                                                            </h4>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    A breezy, lightweight abaya perfect for summer.
                                                                    Designed with soft, breathable fabric
                                                                    to keep you cool while maintaining elegant modest
                                                                    coverage.
                                                                </p>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="dz-shop-card style-2">
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0">
                                                                <a href="shop-list.html">Baggy Shirt & Skirt Co-Ord
                                                                    Set</a>
                                                            </h4>
                                                    ...
                                                    <div class="dz-body">
                                                        <div class="dz-rating-box">
                                                            <div>
                                                                <p class="dz-para">
                                                                    A trendy oversized shirt paired with a flowy skirt.
                                                                    Perfect for everyday wear, offering
                                                                    comfort with a chic street-style vibe.
                                                                </p>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row gx-xl-4 g-3 mb-xl-0 mb-md-0 mb-3">
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Stylish Western Top &
                                                            Bottom
                                                            set made with soft and breathable fabric</a></h5>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Pakistani Eastern Short
                                                            Shirt</a></h5>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Embroidered Silk Shalwar
                                                            Kameez (Green Bottom)</a></h5>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Western Wear – Casual
                                                            Denim Skinny Jeans</a></h5>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Cherry Farshi Set in
                                                            Oversized Fit</a></h5>
                                                    <h5 class="price">PKR 4,500</h5>
                                                </div>
                                                <div class="product-tag">
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Loose Pajama Set – Soft &
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Modest Summer Abaya –
                                                            Lightweight & Breathable</a></h5>
                                    ...
                                    <div class="row gx-xl-4 g-3">
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/clothes/img2-knetted sweater.webp"
                                                        alt="Chic Knitted Sweater Set">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Chic Knitted Sweater Set" data-price="PKR 4,500"
                                                            data-img="images/shop/product/clothes/img2-knetted sweater.webp"
                                                            data-desc="Cozy and stylish knitted sweater set, perfect for casual or semi-formal wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Chic Knitted Sweater
                                                            Set</a></h5>
                                                    <h5 class="price">PKR 4,500</h5>
                                                </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/clothes/img3-turtlenect sweater.webp"
                                                        alt="Elegant Turtleneck Sweater">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Elegant Turtleneck Sweater"
                                                            data-price="PKR 3,850"
                                                            data-img="images/shop/product/clothes/img3-turtlenect sweater.webp"
                                                            data-desc="Elegant knitted turtleneck sweater, warm and stylish, perfect for casual or semi-formal wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Elegant Turtleneck
                                                            Sweater</a></h5>
                                                    <h5 class="price">PKR 3,850</h5>
                                                </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    ...
                                                    <div class="shop-meta">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Embroidered Silk Shalwar Kameez (Green Bottom)"
                                                            data-price="PKR 6,950"
                                                            data-img="images/shop/product/clothes/img4-tieweist.webp"
                                                            data-desc="Elegant embroidered silk shalwar kameez with a green bottom, perfect for festive occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                        <div class="btn btn-primary meta-icon dz-wishicon">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Western Wear – Chic
                                                            Tie-Waist
                                                            Dress</a></h5>
                                                    <h5 class="price">PKR 6,950</h5>
                                                </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img4.jpg"
                                                    ...
                                                    <div class="shop-meta">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Western Wear – Casual Denim Skinny Jeans"
                                                            data-price="PKR 4,250"
                                                            data-img="images/shop/product/img4.jpg"
                                                            data-desc="Classic denim skinny jeans, perfect for casual western wear outfits.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/clothes/img5-sweaterjeans.jpg"
                                                        alt="Western Wear – Chic Tie-Waist Dress">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Western Wear – Chic Tie-Waist Dress"
                                                            data-price="PKR 4,500"
                                                            data-img="images/shop/product/clothes/img5-sweaterjeans.jpg"
                                                            data-desc="Elegant Western wear tie-waist dress, perfect for casual and semi-formal occasions.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/img6.jpg"
                                                        alt="Loose Pajama Set – Soft & Breathable Fabric">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Loose Pajama Set – Soft & Breathable Fabric"
                                                            data-price="PKR 3,500"
                                                            data-img="images/shop/product/img6.jpg"
                                                            data-desc="Comfortable loose pajama set made with soft and breathable fabric, ideal for home or casual wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="images/shop/product/clothes/img5-sweaterjeans.jpg"
                                                        alt="Casual Sweater & Jeans Set">
                                                    <div class="shop-meta">
                                                        <!-- Quick View Button -->
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Casual Sweater & Jeans Set"
                                                            data-price="PKR 5,500"
                                                            data-img="images/shop/product/clothes/img5-sweaterjeans.jpg"
                                                            data-desc="Effortless style meets comfort with this cozy sweater paired with classic jeans — perfect for everyday outings and casual vibes.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Casual Sweater & Jeans
                                                            Set</a></h5>
                                                    <h5 class="price">PKR 5,500</h5>
                                                </div>
                                                ...
                                                <div class="dz-media">
                                                    ...
                                                    <div class="shop-meta">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Baggy Shirt & Skirt Co-Ord Set"
                                                            data-price="PKR 3,600"
                                                            data-img="images/shop/product/img8.jpg"
                                                            data-desc="Loose baggy shirt paired with a flowing skirt, perfect for casual or home wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                        <div class="btn btn-primary meta-icon dz-wishicon">
                                                ...
                                                <div class="dz-media">
                                                    ...
                                                    <div class="shop-meta">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            data-name="Baggy Shirt & Skirt Co-Ord Set"
                                                            data-price="PKR 4,500"
                                                            data-img="images/shop/product/img9.jpg"
                                                            data-desc="Baggy shirt paired with a flowing skirt, perfect for casual wear.">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    ...
                                                    <div class="shop-meta">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded quick-view-btn"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                                            data-name="Wedding Wear – Elegant Collection"
                                                            data-price="PKR 12,500"
                                                            data-img="images/shop/product/clothes/img3-turtlenect sweater.webp"
                                                            data-desc="Stunning LCozy Chic Sweater">
                                                            <i class="fa-solid fa-eye d-md-none d-block"></i>
                                                            <span class="d-md-block d-none">Quick View</span>
                                                        </a>
                                                        <div class="btn btn-primary meta-icon dz-wishicon">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">LCozy Chic Sweater</a>
                                                    </h5>
