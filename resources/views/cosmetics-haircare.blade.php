			...
			<section class="content-inner-3 pt-3 z-index-unset">
				<div class="container-fluid">
									...
									<div class="tab-pane fade active show" id="tab-list-grid" role="tabpanel"
										...
										<div class="row gx-xl-4 g-3">
												...
												<div class="shop-card style-1">
													<div class="dz-media"
													 div style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
																	<img src="images/haircare/1.jpg" alt="image"
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Shampoo</a></h5>
														<h5 class="price">8,000 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images\/haircare/2.jpg" alt="image">
														<div class="shop-meta">
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Conditioner</a></h5>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/haircare/3.jpg" alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Hair Mask</a></h5>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media"
														...
														<img src="images/haircare/4.jpg" alt="image"
                    ...
                    <span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Hair Oil</a></h5>
														<h5 class="price">3,000 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/haircare/5.jpg" alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media"
														style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
														<img src="images/haircare/6 (1).jpg" alt="image"
															style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; object-position: top;">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    <i class="fa-solid fa-eye d-md-none d-block"></i>
                    <span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">LeaveIn
																Conditioner</a></h5>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media"
														...
														<img src="images/haircare/6 (2).jpg" alt="image"
															style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; object-position: top;">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    <i class="fa-solid fa-eye d-md-none d-block"></i>
                    <span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Brush</a></h5>
														<h5 class="price">1,000 PKR</h5>
													</div>
													<div class="product-tag">
														<!-- <span class="badge ">Get 20% Off</span> -->
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media"
														style="position: relative; width: 100%; padding-top: 100%; overflow: hidden;">
														<img src="images/haircare/6 (3).jpg" alt="image"
															style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; object-position: top;">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    <i class="fa-solid fa-eye d-md-none d-block"></i>
                    <span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Scalp Massage</a>
														</h5>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/haircare/7 (1).jpg" alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Hir Gel</a></h5>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/haircare/9.jpg" alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Hair Mousse</a></h5>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media">
														<img src="images/haircare/8.jpg" alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Toner</a></h5>
											...
											<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
												<div class="shop-card style-1">
													<div class="dz-media"
														style="position: relative; width: 100%; padding-top: 100%;">
														<img src="images/haircare/7 (4).jpg"
															style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; object-position: top;"
															alt="image">
														<div class="shop-meta">
															<!-- <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    ...
                    <span class="d-md-block d-none">Quick View</span>
													...
													<div class="dz-content">
														<h5 class="title"><a href="shop-list.html">Spray</a></h5>
